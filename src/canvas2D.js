...
BABYLON.Effect.ShadersStore['ellipse2dPixelShader'] =
  'varying vec4 vColor;\nvoid main(void) {\ngl_FragColor=vColor;\n}';
...
BABYLON.Effect.ShadersStore['lines2dPixelShader'] =
  'varying vec4 vColor;\nvoid main(void) {\ngl_FragColor=vColor;\n}';
...
BABYLON.Effect.ShadersStore['rect2dPixelShader'] =
  'varying vec4 vColor;\nvoid main(void) {\ngl_FragColor=vColor;\n}';
...
BABYLON.Effect.ShadersStore['wireframe2dPixelShader'] =
  'varying vec4 vColor;\nvoid main(void) {\ngl_FragColor=vColor;\n}';
...
(function(BABYLON) {
  ...
  var Tri2DArray = (function() {
    ...
    Tri2DArray.prototype.storeTriangle = function(index, a, b, c) {
      var center = new BABYLON.Vector2(
        (a.x + b.x + c.x) / 3,
        (a.y + b.y + c.y) / 3
      );
    ...
    Tri2DArray.prototype.storeToTri2DInfo = function(index, tri2dInfo) {
      if (index >= this._count) {
        throw new Error(
          "Can't fetch the triangle at index " +
            index +
            ', max index is ' +
            (this._count - 1)
        );
    ...
    /**
         ...
         */
    Tri2DArray.prototype.transformAndStoreToTri2DInfo = function(
      index,
      tri2dInfo,
      transform
    ) {
    ...
    Tri2DArray.doesIntersect = function(setA, setB, bToATransform) {
      ...
      for (var curB = 0; curB < setB.count; curB++) {
        ...
        for (var curA = 0; curA < setA.count; curA++) {
          ...
          if (
            Math2D.TriangleTriangleDosIntersect(a.a, a.b, a.c, b.a, b.b, b.c)
          ) {
            return true;
          }
        }
  ...
  var Math2D = (function() {
    ...
    Math2D.LineLineDoesIntersect = function(segA1, segA2, segB1, segB2) {
      ...
      var s =
        (-s1_y * (segA1.x - segB1.x) + s1_x * (segA1.y - segB1.y)) /
        (-s2_x * s1_y + s1_x * s2_y);
      var t =
        (s2_x * (segA1.y - segB1.y) - s2_y * (segA1.x - segB1.x)) /
        (-s2_x * s1_y + s1_x * s2_y);
      if (s >= 0 && s <= 1 && t >= 0 && t <= 1) {
        return true;
      }
    ...
    Math2D.TriangleTriangleDosIntersect = function(
      tri1A,
      tri1B,
      tri1C,
      tri2A,
      ...
      if (
        BABYLON.Vector2.PointInTriangle(tri2A, tri1A, tri1B, tri1C) &&
        BABYLON.Vector2.PointInTriangle(tri2B, tri1A, tri1B, tri1C) &&
        BABYLON.Vector2.PointInTriangle(tri2C, tri1A, tri1B, tri1C)
      )
        return true;
      if (
        BABYLON.Vector2.PointInTriangle(tri1A, tri2A, tri2B, tri2C) &&
...
(function(BABYLON) {
  ...
  var PropertyChangedBase = (function() {
    ...
    /**
         ...
         */
    PropertyChangedBase.prototype.onPropertyChanged = function(
      propName,
      oldValue,
      newValue,
      mask
      ...
      if (this.propertyChanged.hasObservers()) {
        var pci = PropertyChangedBase.calling
          ? new PropertyChangedInfo()
          : PropertyChangedBase.pci;
...
(function(BABYLON) {
    ...
    C2DLogging.setPostMessage = function(message) {
      if (C2DLoggingInternals.enableLog) {
        C2DLoggingInternals.postMessages[
          C2DLoggingInternals.callDepth - 1
        ] = message();
      }
    };
  ...
  function logProp(message, alsoGet, setNoProlog, getNoProlog) {
    ...
    if (setNoProlog === void 0) {
      setNoProlog = false;
    }
    if (getNoProlog === void 0) {
      getNoProlog = false;
    }
      ...
      if (getter && alsoGet) {
        descriptor.get = function() {
          if (C2DLogging.snooze) {
            ...
            C2DLogging.setPostMessage(function() {
              return '[no msg]';
            });
            ...
            console.log(
              indent +
                ...
                propName +
                ' property => ' +
                C2DLoggingInternals.getFormattedValue(r) +
                flagsStr +
                ', ' +
                C2DLoggingInternals.postMessages[C2DLoggingInternals.callDepth]
            );
            return r;
          }
        };
            ...
            if (!setNoProlog) {
              console.log(
                indent +
                  ...
                  propName +
                  ' property with ' +
                  C2DLoggingInternals.getFormattedValue(val)
              );
            }
            ++C2DLoggingInternals.callDepth;
            C2DLogging.setPostMessage(function() {
    ...
    return function(target, key, descriptor) {
      ...
      descriptor.value = function() {
        ...
        if (C2DLogging.snooze) {
          ...
          var a = args
            .map(function(a) {
              return C2DLoggingInternals.getFormattedValue(a) + ', ';
            })
            .join();
          ...
          console.log(
            indent +
              ...
              a +
              ') Res: ' +
              C2DLoggingInternals.getFormattedValue(result) +
              ', ' +
              C2DLoggingInternals.postMessages[C2DLoggingInternals.callDepth] +
              flagsStr
          );
...
(function(BABYLON) {
  ...
  var ObservableArray = (function(_super) {
    ...
    function ObservableArray(watchObjectsPropertyChange, array) {
      ...
      _this._watchedObjectList = _this._watchObjectsPropertyChange
        ? new BABYLON.StringDictionary()
        : null;
    ...
    ObservableArray.prototype.setAt = function(index, value) {
      ...
      var insertion =
        index >= this._array.length || this._array[index] === undefined;
      var oldLength = 0;
      if (insertion) {
      ...
      if (ac) {
        ac.action = insertion
          ? ArrayChanged.newItemsAction
          : ArrayChanged.changedItemAction;
        if (insertion) {
    ...
    ObservableArray.prototype.concat = function() {
      ...
      return new ObservableArray(
        this._watchObjectsPropertyChange,
        (_a = this._array).concat.apply(_a, items)
      );
      var _a;
    };
    /**
    ...
    ObservableArray.prototype.splice = function(start, deleteCount) {
      ...
      var res = (_a = this._array).splice.apply(
        _a,
    ...
    ObservableArray.prototype.unshift = function() {
      ...
      if (ac) {
        ac.clear();
        ac.action = ArrayChanged.replacedArrayAction;
        (ac.newStartingIndex = 0), this.feedNotifArray.apply(
          this,
          [ac.newItems, 0].concat(items)
        );
        this.callArrayChanged(ac);
      }
      return res;
    ...
    ObservableArray.prototype._addWatchedElement = function() {
      ...
      var _loop_1 = function(curItem) {
        if (curItem['propertyChanged']) {
          ...
          this_1._watchedObjectList.add(
            key_1,
            curItem.propertyChanged.add(function(e, d) {
    ...
    ObservableArray.prototype.onWatchedObjectChanged = function(
      key,
      object,
      propChanged
    ) {
      if (
        this._watchedObjectChanged &&
        this._watchedObjectChanged.hasObservers()
      ) {
        var woci = this._callingWatchedObjectChanged
          ? new OAWatchedObjectChangedInfo()
          : this._woci;
        woci.object = object;
  ...
  var ObservableStringDictionary = (function(_super) {
    ...
    ObservableStringDictionary.prototype.copyFrom = function(source) {
      ...
      this.onDictionaryChanged(
        DictionaryChanged.replacedAction,
        null,
        null,
        null
      );
    ...
    /**
         ...
         */
    ObservableStringDictionary.prototype.getOrAddWithFactory = function(
      key,
      factory
    ) {
      var _this = this;
      var val = _super.prototype.getOrAddWithFactory.call(this, key, function(
        k
      ) {
        var v = factory(key);
    ...
    ObservableStringDictionary.prototype._add = function(
      key,
      value,
      fireNotif,
      registerWatcher
      ...
      if (_super.prototype.add.call(this, key, value)) {
        if (fireNotif) {
          this.onDictionaryChanged(
            DictionaryChanged.newItemAction,
            { key: key, value: value },
            null,
            null
          );
    ...
    ObservableStringDictionary.prototype._addWatchedElement = function(
      key,
      el
    ) {
      var _this = this;
      if (el['propertyChanged']) {
        this._watchedObjectList.add(
          key,
          el.propertyChanged.add(function(e, d) {
            _this.onWatchedObjectChanged(key, el, e);
          })
        );
      }
    };
    ObservableStringDictionary.prototype._removeWatchedElement = function(
      key,
      el
    ) {
      var observer = this._watchedObjectList.getAndRemove(key);
    ...
    ObservableStringDictionary.prototype.set = function(key, value) {
      ...
      if (_super.prototype.set.call(this, key, value)) {
        this.onDictionaryChanged(
          DictionaryChanged.itemValueChangedAction,
          null,
          null,
    ...
    ObservableStringDictionary.prototype._remove = function(
      key,
      fireNotif,
      element
    ) {
      ...
      this.onDictionaryChanged(
        DictionaryChanged.removedItemAction,
        null,
        key,
        null
      );
    ...
    Object.defineProperty(
      ObservableStringDictionary.prototype,
      'propertyChanged',
      {
        get: function() {
          if (!this._propertyChanged) {
    ...
    ObservableStringDictionary.prototype.onPropertyChanged = function(
      propName,
      oldValue,
      newValue,
      mask
      ...
      if (this._propertyChanged && this._propertyChanged.hasObservers()) {
        var pci = ObservableStringDictionary.callingPropChanged
          ? new BABYLON.PropertyChangedInfo()
          : ObservableStringDictionary.pci;
        pci.oldValue = oldValue;
        pci.newValue = newValue;
        pci.propertyName = propName;
        try {
    ...
    ObservableStringDictionary.prototype.onDictionaryChanged = function(
      action,
      newItem,
      removedKey,
      changedItem
    ...
    ObservableStringDictionary.prototype.onWatchedObjectChanged = function(
      key,
      object,
      propChanged
    ) {
      if (
        ...
        var woci = this._callingWatchedObjectChanged
          ? new OSDWatchedObjectChangedInfo()
          : this._woci;
        woci.key = key;
        woci.object = object;
        woci.propertyChanged = propChanged;
...
(function(BABYLON) {
  ...
  var BaseFontTexture = (function(_super) {
    ...
    function BaseFontTexture(
      ...
      var _this =
        _super.call(this, url, scene, noMipmap, invertY, samplingMode) || this;
      ...
      for (var _i = 0, text_1 = text; _i < text_1.length; _i++) {
        ...
        if (!ci) {
          throw new Error(
            'Character ' +
              char +
              ' is not supported by FontTexture ' +
              this.name
          );
        }
  ...
  var BitmapFontTexture = (function(_super) {
      ...
      xhr.onreadystatechange = function() {
        if (xhr.readyState === XMLHttpRequest.DONE) {
          if (xhr.status === 200) {
            ...
            var plugins = BitmapFontTexture.plugins.get(
            ...
            var _loop_1 = function(p) {
              ...
              if (ret) {
                ...
                if (textureUrl != null) {
                  ...
                  var baseUrl = bmFontUrl.substr(
                    0,
                    bmFontUrl.lastIndexOf('/') + 1
                  );
                  bfi.textureUrl = baseUrl + bfi.textureFile;
                }
                _this._texture = scene
                  .getEngine()
                  .createTexture(
                    bfi.textureUrl,
                    noMipmap,
                ...
                if (ci) {
                  ...
                  _this._charInfos.first(function(k, v) {
                    return (_this._spaceWidth = v.charWidth);
                  });
                }
                if (!ret.bfi && onError) {
            ...
            if (onError) {
              onError(
                "Couldn't load file through HTTP Request, HTTP Status " +
                  xhr.status,
                xhr.status
              );
            }
    ...
    BitmapFontTexture.GetCachedFontTexture = function(scene, fontTexture) {
      var dic = scene.getOrAddExternalDataWithFactory(
        'BitmapFontTextureCache',
        function() {
    ...
    BitmapFontTexture.addLoader = function(fileExtension, plugin) {
      var a = BitmapFontTexture.plugins.getOrAddWithFactory(
  ...
  var FontTexture = (function(_super) {
    ...
    function FontTexture(
      ...
      if (maxCharCount === void 0) {
        maxCharCount = 200;
      }
      if (samplingMode === void 0) {
        samplingMode = BABYLON.Texture.TRILINEAR_SAMPLINGMODE;
      }
      if (superSample === void 0) {
        superSample = false;
      }
      if (signedDistanceField === void 0) {
        signedDistanceField = false;
      }
      var _this =
        _super.call(this, null, scene, true, false, samplingMode) || this;
      ...
      _this._lineHeight = _this._superSample
        ? Math.ceil(_this._lineHeightSuper / 2)
        : _this._lineHeightSuper;
      _this._offset = res.offset;
      res = _this.getFontHeight(font, 'f');
      _this._baseLine = res.height + res.offset - _this._offset;
      var maxCharWidth = Math.max(
        _this._context.measureText('W').width,
        _this._context.measureText('_').width
      );
      _this._spaceWidthSuper = _this._context.measureText(' ').width;
      _this._spaceWidth = _this._superSample
        ? _this._spaceWidthSuper / 2
        : _this._spaceWidthSuper;
      _this._xMargin = Math.ceil(maxCharWidth / 32);
      _this._yMargin = _this._xMargin;
      // This is an approximate size, but should always be able to fit at least the maxCharCount
      var totalEstSurface =
        (Math.ceil(_this._lineHeightSuper) + _this._yMargin * 2) *
        (Math.ceil(maxCharWidth) + _this._xMargin * 2) *
        maxCharCount;
      ...
      _this._texture = scene
        .getEngine()
        .createDynamicTexture(textSize, textSize, false, samplingMode);
      ...
      if (_this._signedDistanceField) {
        ...
        sdfC.height =
          (Math.ceil(_this._lineHeightSuper) + _this._yMargin * 2) * s;
    ...
    FontTexture.GetCachedFontTexture = function(
      scene,
      fontName,
      supersample,
      signedDistanceField,
      ...
      var lfn =
        ...
        (supersample ? '_+SS' : '_-SS') +
        (signedDistanceField ? '_+SDF' : '_-SDF') +
        (bilinearFiltering ? '_+BF' : '_-BF');
      var ft = dic.get(lfn);
      if (ft) {
        ++ft._usedCounter;
        return ft;
      ...
      ft = new FontTexture(
        ...
        scene,
        supersample ? 100 : 200,
        signedDistanceField || bilinearFiltering
    ...
    FontTexture.ReleaseCachedFontTexture = function(
      scene,
      fontName,
      supersample,
      signedDistanceField,
    ...
    FontTexture.prototype.getChar = function(char) {
      ...
      if (
        ...
        this._currentFreePosition.y += Math.ceil(
          this._lineHeightSuper + this._yMargin * 2
        );
        // No more room?
      ...
      var drawDebug = function(ctx) {
        ...
        ctx.lineTo(
          curPosXMargin + width,
          curPosYMargin + Math.round(_this._baseLine)
        );
        ctx.closePath();
        ctx.stroke();
      };
      ...
      if (this._signedDistanceField) {
        ...
        this._sdfContext.clearRect(
          0,
          0,
          this._sdfCanvas.width,
          this._sdfCanvas.height
        );
        // Coordinates are subject to the context's scale
        this._sdfContext.fillText(
          char,
          this._xMargin + 0.5,
          this._yMargin + 0.5 - this._offset
        );
        // Canvas Pixel Coordinates, no scale
        var data = this._sdfContext.getImageData(
          0,
          0,
          (width + this._xMargin * 2) * s,
          this._sdfCanvas.height
        );
        ...
        this._context.fillText(
          char,
          curPosXMargin,
          curPosYMargin - this._offset
        );
        // Premul Alpha manually
        var id = this._context.getImageData(
          curPosXMargin,
          curPosYMargin,
          width,
          this._lineHeightSuper
        );
      ...
      info.topLeftUV = new BABYLON.Vector2(
        (curPosXMargin - 0.5) / textureSize.width,
        (this._currentFreePosition.y - 0.5 + this._yMargin) / textureSize.height
      );
      info.bottomRightUV = new BABYLON.Vector2(
        (curPosXMargin - 0.5 + width) / textureSize.width,
        info.topLeftUV.y + this._lineHeightSuper / textureSize.height
      );
    ...
    FontTexture.prototype.update = function() {
      ...
      if (this._lastUpdateCharCount < this._curCharCount) {
        this.getScene()
          .getEngine()
          .updateDynamicTexture(this._texture, this._canvas, false, true);
  ...
  var BMFontLoaderTxt = (BMFontLoaderTxt_1 = (function() {
    ...
    BMFontLoaderTxt.prototype._parseStrToObj = function(str) {
      ...
      for (var i = 0, li = arr.length; i < li; i++) {
        ...
        if (value.match(BMFontLoaderTxt_1.INT_EXP)) value = parseInt(value);
        else if (value[0] === '"') value = value.substring(1, value.length - 1);
        obj[key] = value;
      }
      return obj;
    };
    BMFontLoaderTxt.prototype._buildCharInfo = function(
      bfi,
      initialLine,
      obj,
      textureSize,
      ...
      if (
        ...
        if (invertY) {
          ci.topLeftUV = new BABYLON.Vector2(
            1 - x / textureSize.width,
            1 - y / textureSize.height
          );
          ci.bottomRightUV = new BABYLON.Vector2(
            1 - (x + width) / textureSize.width,
            1 - (y + height) / textureSize.height
          );
        } else {
          ci.topLeftUV = new BABYLON.Vector2(
            x / textureSize.width,
          ...
          ci.bottomRightUV = new BABYLON.Vector2(
            (x + width) / textureSize.width,
            (y + height) / textureSize.height
          );
        }
        ci.charWidth = width;
        chars.add(char, ci);
    ...
    BMFontLoaderTxt.prototype.loadFont = function(fontContent, scene, invertY) {
      ...
      bfi.padding = new BABYLON.Vector4(
        parseInt(paddingArr[0]),
        parseInt(paddingArr[1]),
        parseInt(paddingArr[2]),
        parseInt(paddingArr[3])
      );
      //common
      var commonObj = this._parseStrToObj(
        fontStr.match(BMFontLoaderTxt_1.COMMON_EXP)[0]
      );
      bfi.lineHeight = commonObj['lineHeight'];
      bfi.baseLine = commonObj['base'];
      bfi.textureSize = new BABYLON.Size(
        commonObj['scaleW'],
        commonObj['scaleH']
      );
      var maxTextureSize = scene.getEngine()._gl.getParameter(0xd33);
      if (
        commonObj['scaleW'] > maxTextureSize.width ||
        commonObj['scaleH'] > maxTextureSize.height
      ) {
        ...
        if (commonObj['pages'] !== 1) {
          ...
          //page
          var pageObj = this._parseStrToObj(
            fontStr.match(BMFontLoaderTxt_1.PAGE_EXP)[0]
          );
          if (pageObj['id'] !== 0) {
            ...
            if (kerningLines) {
              for (var i = 0, li = kerningLines.length; i < li; i++) {
                ...
                bfi.kerningDic.add(
                  ((kerningObj['first'] << 16) |
                    (kerningObj['second'] & 0xffff)).toString(),
                  kerningObj['amount']
                );
              }
            }
...
(function(BABYLON) {
  ...
  var BoundingInfo2D = (function() {
    ...
    BoundingInfo2D.prototype.equals = function(other) {
      ...
      return (
        other.center.equals(this.center) && other.extent.equals(this.extent)
      );
    };
    /**
    ...
    BoundingInfo2D.prototype._updateWorldAABB = function(worldMatrix) {
      ...
      this._worldAABB.x = Math.min(
        Math.min(p[0].x, p[1].x),
        Math.min(p[2].x, p[3].x)
      );
      this._worldAABB.y = Math.min(
        Math.min(p[0].y, p[1].y),
        Math.min(p[2].y, p[3].y)
      );
      this._worldAABB.z = Math.max(
        Math.max(p[0].x, p[1].x),
        Math.max(p[2].x, p[3].x)
      );
      this._worldAABB.w = Math.max(
        Math.max(p[0].y, p[1].y),
        Math.max(p[2].y, p[3].y)
      );
    };
    Object.defineProperty(
      BoundingInfo2D.prototype,
      'worldAABBDirtyObservable',
      {
        get: function() {
    ...
    BoundingInfo2D.prototype.dirtyWorldAABB = function() {
      ...
      this._worldAABBDirty = true;
      if (
        this._worldAABBDirtyObservable &&
        this._worldAABBDirtyObservable.hasObservers()
      ) {
      ...
      get: function() {
        if (this._worldAABBDirty) {
          if (!this.worldMatrixAccess) {
            throw new Error(
              'you must set the worldMatrixAccess function first'
            );
          }
    ...
    BoundingInfo2D.prototype.unionToRef = function(other, result) {
      var xmax = Math.max(
        ...
        other.center.x + other.extent.x
      );
      var ymax = Math.max(
        this.center.y + this.extent.y,
        other.center.y + other.extent.y
      );
      var xmin = Math.min(
        this.center.x - this.extent.x,
        other.center.x - other.extent.x
    ...
    BoundingInfo2D.prototype.doesIntersect = function(pickPosition) {
      ...
      if (pickLocal.lengthSquared() <= this.radius * this.radius) {
        ...
        return (
          Math.abs(pickLocal.x) <= this.extent.x &&
          Math.abs(pickLocal.y) <= this.extent.y
        );
      }
      return false;
    };
  ...
  BoundingInfo2D._transform = new Array(
...
(function(BABYLON) {
  ...
  var PrimitiveCollisionManagerBase = (function() {
    ...
    PrimitiveCollisionManagerBase.allocBasicPCM = function(
      owner,
      enableBorders
    ) {
    ...
    Object.defineProperty(ActorInfo.prototype, 'worldAABB', {
      get: function() {
        return (this.isSomeFlagsSet(ActorInfo.flagDeep)
          ? this.prim.boundingInfo
          : this.prim.levelBoundingInfo).worldAABB;
      },
      enumerable: true,
      configurable: true,
    });
  ...
  var BasicPrimitiveCollisionManager = (function(_super) {
    ...
    function BasicPrimitiveCollisionManager(owner, enableBorders) {
      ...
      for (var j = 0; j < 4; j++) {
        _this._borderIntersecteddActors[
          j
        ] = new BABYLON.ObservableStringDictionary(false);
      }
      ...
      if (!BasicPrimitiveCollisionManager.WAABBCorners) {
        ...
        for (var i = 0; i < 4; i++) {
          BasicPrimitiveCollisionManager.WAABBCorners[
            i
          ] = BABYLON.Vector2.Zero();
        }
        BasicPrimitiveCollisionManager.WAABBCornersCluster = new Array(4);
        for (var i = 0; i < 4; i++) {
          BasicPrimitiveCollisionManager.WAABBCornersCluster[
            i
          ] = BABYLON.Vector2.Zero();
        }
      }
    ...
    BasicPrimitiveCollisionManager.prototype._update = function() {
      ...
      if (
        ((this._clusterSize.width < 16 &&
          this._clusterSize.height < 16 &&
          this._maxActorByCluster >= 10) ||
          (this._clusterSize.width > 2 &&
            this._clusterSize.height > 2 &&
            this._maxActorByCluster <= 7)) &&
        ...
        console.log(
          'Change cluster size to ' +
            cw +
            ':' +
            ch +
            ', max actor ' +
            this._maxActorByCluster
        );
      ...
      var updateStats =
        this.debugStats && (this._dirtyActors.count > 0 || this._clusterDirty);
    ...
    Object.defineProperty(
      BasicPrimitiveCollisionManager.prototype,
      'debugRenderAABB',
      {
        /**
    ...
    BasicPrimitiveCollisionManager.prototype._initializeCluster = function(
      countW,
      countH
    ) {
      // Check for free
      ...
      this._clusterStep.copyFromFloats(
        this._owner.actualWidth / countW,
        this._owner.actualHeight / countH
      );
    ...
    BasicPrimitiveCollisionManager.prototype._processActor = function(actor) {
      ...
      for (var y = sy; y <= ey; y++) {
        var _loop_1 = function(x) {
          ...
          var ci = actor.presentInClusters.getOrAddWithFactory(k, function(k) {
            ...
            _this._maxActorByCluster = Math.max(
              _this._maxActorByCluster,
              nci.actors.count
            );
            ++opCount;
            ++totalClusters;
      ...
      for (
        var _i = 0, clusterToRemove_1 = clusterToRemove;
        _i < clusterToRemove_1.length;
        _i++
      ) {
    ...
    BasicPrimitiveCollisionManager.prototype._collisionDetection = function() {
      ...
      this._dirtyActors.forEach(function(k1, ai1) {
        ...
        ai1.presentInClusters.forEach(function(k, ci) {
          ++opCount;
          ci.actors.forEach(function(k, v) {
            return hash.add(k, v);
          });
        });
        ...
        hash.forEach(function(k2, ai2) {
          ...
          if (
            ...
            if (ai1.prim.intersectOtherPrim(ai2.prim)) {
              ...
              if (k1 < k2) {
                _this._intersectedActors.add(k1 + ';' + k2, {
                  a: ai1.prim,
                  b: ai2.prim,
                });
              } else {
                _this._intersectedActors.add(k2 + ';' + k1, {
                  a: ai2.prim,
                  b: ai1.prim,
                });
              }
        ...
        prev.forEach(function(k, ai) {
          if (!ai1.intersectWith.contains(k)) {
            ++opCount;
            _this._intersectedActors.remove(
              (k < k1 ? k : k1) + ';' + (k < k1 ? k1 : k)
            );
          }
        });
    ...
    BasicPrimitiveCollisionManager.prototype._updateDebugStats = function() {
      ...
      var txt =
        'Primitive Collision Stats\n' +
        (' - PCM Execution Time: ' +
          format(this._debugUpdateTime.lastSecAverage) +
          'ms\n') +
        (' - Operation Count: ' +
          format(this._debugUpdateOpCount.current) +
          ', (avg:' +
          format(this._debugUpdateOpCount.lastSecAverage) +
          ', t:' +
          format(this._debugUpdateOpCount.total) +
          ')\n') +
    ...
    BasicPrimitiveCollisionManager.prototype._updateAABBDisplay = function() {
      var g = new BABYLON.WireFrameGroup2D(
        'main',
        new BABYLON.Color4(0.5, 0.8, 1.0, 1.0)
      );
      ...
      if (!this._AABBRenderPrim) {
        this._AABBRenderPrim = new BABYLON.WireFrame2D([g], {
          parent: this._owner,
          alignToPixel: true,
          id: '###DEBUG PCM AABB###',
        });
    ...
    BasicPrimitiveCollisionManager.prototype._updateClusterDisplay = function(
      cw,
      ch
    ) {
      var g = new BABYLON.WireFrameGroup2D(
        'main',
        new BABYLON.Color4(0.8, 0.1, 0.5, 1.0)
      );
      ...
      if (!this._ClusterRenderPrim) {
        this._ClusterRenderPrim = new BABYLON.WireFrame2D([g], {
          parent: this._owner,
          alignToPixel: true,
          id: '###DEBUG PCM Clusters###',
        });
      } else {
...
(function(BABYLON) {
  var LayoutEngineBase = (function() {
    ...
    Object.defineProperty(
      LayoutEngineBase.prototype,
      'isChildPositionAllowed',
      {
        get: function() {
          return false;
        },
  ...
  var CanvasLayoutEngine = (CanvasLayoutEngine_1 = (function(_super) {
    ...
    function CanvasLayoutEngine() {
      var _this = _super.call(this) || this;
      _this.layoutDirtyOnPropertyChangedMask =
        BABYLON.Prim2DBase.sizeProperty.flagId |
        BABYLON.Prim2DBase.actualSizeProperty.flagId;
      return _this;
    }
  ...
  var StackPanelLayoutEngine = (StackPanelLayoutEngine_1 = (function(_super) {
    ...
    StackPanelLayoutEngine.prototype.updateLayout = function(prim) {
      if (prim._isFlagSet(BABYLON.SmartPropertyPrim.flagLayoutDirty)) {
        ...
        var max = 0;
        var stackPanelLayoutArea =
          StackPanelLayoutEngine_1.stackPanelLayoutArea;
        ...
        for (var _i = 0, _a = prim.children; _i < _a.length; _i++) {
          ...
          if (child._hasMargin) {
            ...
            child.margin.computeWithAlignment(
              stackPanelLayoutArea,
              child.actualSize,
              child.marginAlignment,
              child.actualScale,
              StackPanelLayoutEngine_1.dstOffset,
              StackPanelLayoutEngine_1.dstArea,
              true
            );
            child.layoutArea = StackPanelLayoutEngine_1.dstArea;
          } else {
            child.margin.computeArea(
              child.actualSize,
              child.actualScale,
              StackPanelLayoutEngine_1.dstArea
            );
          ...
          max = Math.max(
            max,
            horizonStackPanel
              ? StackPanelLayoutEngine_1.dstArea.height
              : StackPanelLayoutEngine_1.dstArea.width
          );
        }
    ...
    Object.defineProperty(
      StackPanelLayoutEngine.prototype,
      'isChildPositionAllowed',
      {
        get: function() {
          return false;
  ...
  var GridPanelLayoutEngine = (GridPanelLayoutEngine_1 = (function(_super) {
        ...
        for (var _i = 0, _a = prim.children; _i < _a.length; _i++) {
          ...
          if (child._hasMargin) {
            child.margin.computeWithAlignment(
              ...
              child.marginAlignment,
              child.actualScale,
              GridPanelLayoutEngine_1.dstOffset,
              GridPanelLayoutEngine_1.dstArea,
              true
            );
          } else {
            child.margin.computeArea(
    ...
    Object.defineProperty(
      GridPanelLayoutEngine.prototype,
      'isChildPositionAllowed',
      {
        get: function() {
          return false;
    ...
    GridPanelLayoutEngine.prototype._getMaxChildWidthInColumn = function(
      colNum
    ) {
    ...
    GridPanelLayoutEngine.prototype._updateGrid = function(prim) {
      ...
      if (starIndexes.length > 0) {
        ...
        for (var i_4 = 0; i_4 < starIndexes.length; i_4++) {
          ...
          var starHeight =
            this._rows[rowIndex].height / totalStars * remainingHeight;
      ...
      if (starIndexes.length > 0) {
        ...
        for (var i_6 = 0; i_6 < starIndexes.length; i_6++) {
          ...
          var starWidth =
            this._columns[columnIndex].width / totalStars * remainingWidth;
...
(function(BABYLON) {
  ...
  var GradientColorBrush2D = (function(_super) {
    ...
    GradientColorBrush2D.prototype.isTransparent = function() {
      return (
        (this._color1 && this._color1.a < 1.0) ||
        (this._color2 && this._color2.a < 1.0)
      );
    };
    ...
    /**
         ...
         */
    GradientColorBrush2D.BuildKey = function(
      color1,
      color2,
      translation,
      rotation,
...
(function(BABYLON) {
  ...
  var ClassTreeInfo = (function() {
    ...
    Object.defineProperty(ClassTreeInfo.prototype, 'classContent', {
      get: function() {
        if (!this._classContent) {
          this._classContent = this._classContentFactory(
            this._baseClass ? this._baseClass.classContent : null
          );
        }
    ...
    ClassTreeInfo.prototype.getLevelOf = function(type) {
      ...
      var curProtoContent = this.getOrAddType(
  ...
  var DataBinding = (DataBinding_1 = (function() {
    function DataBinding() {
      ...
      this._updateSourceTrigger =
        DataBinding_1.UPDATESOURCETRIGGER_PROPERTYCHANGED;
      this._boundTo = null;
      this._owner = null;
    ...
    DataBinding.prototype._storeBoundValue = function(watcher, value) {
      if (
        ...
        this.mode === DataBinding_1.MODE_ONETIME
      ) {
        return;
      }
      var newValue = value;
  ...
  var SmartPropertyBase = (SmartPropertyBase_1 = (function(_super) {
    ...
    /**
         ...
         */
    SmartPropertyBase.prototype.getOrAddExternalDataWithFactory = function(
      key,
      factory
    ) {
      if (!this._externalData) {
    ...
    SmartPropertyBase._hookProperty = function(
      propId,
      piStore,
      kind,
      settings
      ...
      return function(target, propName, descriptor) {
        ...
        var propInfo = SmartPropertyBase_1._createPropInfo(
          target,
          propName,
          propId,
          kind,
        ...
        var getter = descriptor.get,
          setter = descriptor.set;
        var typeLevelCompare =
          settings.typeLevelCompare !== undefined
            ? settings.typeLevelCompare
            : false;
        // Overload the property setter implementation to add our own logic
        descriptor.set = function(val) {
          if (!setter) {
            throw Error(
              "Property '" +
                propInfo.name +
                "' of type '" +
                BABYLON.Tools.getFullClassName(this) +
                "' has no setter defined but was invoked as if it had one."
            );
          }
    ...
    SmartPropertyBase._createPropInfo = function(
      target,
      propName,
      propId,
      kind,
      ...
      if (propInfo) {
        throw new Error(
          'The ID ' +
            propId +
            ' is already taken by another property declaration named: ' +
            propInfo.name
        );
      }
      ...
      propInfo.bindingMode =
        settings.bindingMode !== undefined
          ? settings.bindingMode
          : DataBinding.MODE_TWOWAY;
      propInfo.bindingUpdateSourceTrigger =
        settings.bindingUpdateSourceTrigger !== undefined
          ? settings.bindingUpdateSourceTrigger
          : DataBinding.UPDATESOURCETRIGGER_PROPERTYCHANGED;
      propInfo.dirtyBoundingInfo =
        settings.dirtyBoundingInfo !== undefined
          ? settings.dirtyBoundingInfo
          : false;
      propInfo.dirtyParentBoundingInfo =
        settings.dirtyParentBoundingBox !== undefined
          ? settings.dirtyParentBoundingBox
          : false;
      propInfo.typeLevelCompare =
        settings.typeLevelCompare !== undefined
          ? settings.typeLevelCompare
          : false;
    ...
    Object.defineProperty(SmartPropertyBase.prototype, 'propDic', {
      ...
      get: function() {
        if (!this._propInfo) {
          ...
          if (!cti) {
            throw new Error(
              "Can't access the propDic member in class definition, is this class SmartPropertyPrim based?"
            );
          }
    ...
    SmartPropertyBase._checkUnchanged = function(curValue, newValue) {
      ...
      if (
        ...
        (curValue === undefined && newValue === undefined)
      ) {
        return true;
      }
    ...
    SmartPropertyBase.prototype._handlePropChanged = function(
      curValue,
      newValue,
      propName,
      propInfo,
      ...
      var info = SmartPropertyBase_1.propChangeGuarding
        ? new BABYLON.PropertyChangedInfo()
        : SmartPropertyPrim.propChangedInfo;
    ...
    SmartPropertyBase.prototype._triggerPropertyChanged = function(
      propInfo,
      newValue
    ) {
      if (this.isDisposed) {
    ...
    SmartPropertyBase.prototype.createSimpleDataBinding = function(
      propInfo,
      propertyPathName,
      mode
    ) {
    ...
    SmartPropertyBase.prototype.createDataBinding = function(
      propInfo,
      binding
    ) {
      if (!this._bindings) {
  ...
  __decorate(
    [BABYLON.logProp()],
    SmartPropertyBase.prototype,
    '_triggerPropertyChanged',
    null
  );
  ...
  var MonitoredObjectData = (function() {
    ...
    MonitoredObjectData.prototype.propertyChangedHandler = function(
      propName,
      oldValue,
      newValue
    ) {
      ...
      if ((this.boundPropertiesMask & propId) !== 0) {
        ...
        for (
          var _i = 0, bindingInfos_1 = bindingInfos;
          _i < bindingInfos_1.length;
          _i++
        ) {
          var bi = bindingInfos_1[_i];
          if (!bi.isLast) {
            BindingHelper.unregisterDataSource(
              this.monitoredObject,
              bi.binding,
              bi.level
            );
            BindingHelper.registerDataSource(
              bi.binding._currentDataSource,
              bi.binding
            );
          }
  ...
  var BindingHelper = (function() {
    ...
    BindingHelper.registerDataSource = function(dataSource, binding) {
      ...
      var _loop_1 = function(i) {
        ...
        if (ownerMod) {
          ...
          mod = ownerMod.monitoredIntermediateProperties.getOrAddWithFactory(
            oii_1.toString(),
            function(k) {
        ...
        var m = mod;
        var bindingInfos = mod.boundProperties.getOrAddWithFactory(
          propIdStr,
          function(k) {
        ...
        if (!bi) {
          bindingInfos.push(
            new BindingInfo(binding, i, i + 1 === properties.length)
          );
        }
        ownerMod = mod;
    ...
    BindingHelper._unregisterBinding = function(mod, propertyID, binding) {
      ...
      if (
        mod.boundPropertiesMask === 0 &&
        mod.monitoredIntermediateMask === 0
      ) {
    ...
    BindingHelper._getMonitoredObjectData = function(object) {
      ...
      var mod = BindingHelper._monitoredObjects.getOrAddWithFactory(
        objectId,
        function(k) {
    ...
    BindingHelper._getObjectTypePropertyIDs = function(obj) {
      ...
      if (!fullName) {
        throw Error(
          'Types involved in Data Binding must be decorated with the @className decorator'
        );
      }
      var d = BindingHelper._propertiesID.getOrAddWithFactory(
        fullName,
        function() {
          return new BABYLON.StringDictionary();
        }
  ...
  var SmartPropertyPrim = (SmartPropertyPrim_1 = (function(_super) {
    ...
    Object.defineProperty(SmartPropertyPrim.prototype, 'modelKey', {
      ...
      get: function() {
        ...
        if (
          !this._isFlagSet(SmartPropertyPrim_1.flagModelDirty) &&
          this._modelKey
        ) {
          ...
          if (v.kind === Prim2DPropInfo.PROPKIND_MODEL) {
            ...
            if (propVal && propVal.constructor === Array) {
              ...
              if (!firstVal) {
                ...
                propVal = BABYLON.Tools.hashCodeFromStream(
                  BABYLON.Tools.arrayOrStringFeeder(propVal)
                );
              }
            }
            var value = '[null]';
    ...
    Object.defineProperty(SmartPropertyPrim.prototype, 'isDirty', {
      ...
      get: function() {
        return (
          this._instanceDirtyFlags !== 0 ||
          this._areSomeFlagsSet(
            SmartPropertyPrim_1.flagModelDirty |
              SmartPropertyPrim_1.flagModelUpdate |
              SmartPropertyPrim_1.flagPositioningDirty |
              SmartPropertyPrim_1.flagLayoutDirty
          )
        );
      },
      enumerable: true,
    ...
    SmartPropertyPrim.prototype._boundingBoxDirty = function() {
      this._setFlags(
        SmartPropertyPrim_1.flagLevelBoundingInfoDirty |
          SmartPropertyPrim_1.flagLayoutBoundingInfoDirty
      );
      ...
      if (this instanceof BABYLON.Prim2DBase) {
        ...
        while (curprim) {
          curprim._setFlags(
            SmartPropertyPrim_1.flagBoundingInfoDirty |
              SmartPropertyPrim_1.flagLayoutBoundingInfoDirty
          );
          if (curprim.isSizeAuto) {
            curprim.onPrimitivePropertyDirty(
              BABYLON.Prim2DBase.sizeProperty.flagId
            );
    ...
    SmartPropertyPrim.prototype._handlePropChanged = function(
      curValue,
      newValue,
      propName,
      propInfo,
      ...
      _super.prototype._handlePropChanged.call(
        this,
        curValue,
        newValue,
        propName,
      ...
      if (this instanceof BABYLON.Prim2DBase) {
        ...
        if (
          p != null &&
          p.layoutEngine &&
          (p.layoutEngine.layoutDirtyOnPropertyChangedMask &
            propInfo.flagId) !==
            0
        ) {
          p._setLayoutDirty();
        ...
        if (
          that.layoutEngine &&
          (that.layoutEngine.layoutDirtyOnPropertyChangedMask &
            propInfo.flagId) !==
            0
        ) {
      ...
      if (!instanceDirty && propInfo.kind === Prim2DPropInfo.PROPKIND_MODEL) {
        ...
        instanceDirty ||
        propInfo.kind === Prim2DPropInfo.PROPKIND_INSTANCE ||
        propInfo.kind === Prim2DPropInfo.PROPKIND_DYNAMIC
      ) {
        var propMask = propInfo.flagId;
        this.onPrimitivePropertyDirty(propMask);
      }
    };
    SmartPropertyPrim.prototype.onPrimitivePropertyDirty = function(
      propFlagId
    ) {
      this.onPrimBecomesDirty();
    ...
    SmartPropertyPrim.prototype._resetPropertiesDirty = function() {
      ...
      this._clearFlags(
        SmartPropertyPrim_1.flagPrimInDirtyList |
          SmartPropertyPrim_1.flagNeedRefresh
      );
    };
    ...
    SmartPropertyPrim.prototype._getFlagsDebug = function(flags) {
      ...
      if (flags & SmartPropertyPrim_1.flagModelDirty) res += 'ModelDirty, ';
      if (flags & SmartPropertyPrim_1.flagLayoutDirty) res += 'LayoutDirty, ';
      if (flags & SmartPropertyPrim_1.flagLevelVisible) res += 'LevelVisible, ';
      if (flags & SmartPropertyPrim_1.flagBoundingInfoDirty)
        res += 'BoundingInfoDirty, ';
      if (flags & SmartPropertyPrim_1.flagIsPickable) res += 'IsPickable, ';
      if (flags & SmartPropertyPrim_1.flagIsVisible) res += 'IsVisible, ';
      ...
      if (flags & SmartPropertyPrim_1.flagTrackedGroup) res += 'TrackedGroup, ';
      ...
      if (flags & SmartPropertyPrim_1.flagZOrderDirty) res += 'ZOrderDirty, ';
      ...
      if (flags & SmartPropertyPrim_1.flagPrimInDirtyList)
        res += 'PrimInDirtyList, ';
      if (flags & SmartPropertyPrim_1.flagIsContainer) res += 'IsContainer, ';
      if (flags & SmartPropertyPrim_1.flagNeedRefresh) res += 'NeedRefresh, ';
      ...
      if (flags & SmartPropertyPrim_1.flagCollisionActor)
        res += 'CollisionActor, ';
      if (flags & SmartPropertyPrim_1.flagModelUpdate) res += 'ModelUpdate, ';
  ...
  function dependencyProperty(propId, piStore, mode, updateSourceTrigger) {
    ...
    return SmartPropertyBase._hookProperty(
      propId,
      piStore,
      Prim2DPropInfo.PROPKIND_DYNAMIC,
      { bindingMode: mode, bindingUpdateSourceTrigger: updateSourceTrigger }
    );
  }
  BABYLON.dependencyProperty = dependencyProperty;
  function modelLevelProperty(
    propId,
    piStore,
    typeLevelCompare,
    dirtyBoundingInfo,
    dirtyParentBoundingBox
  ) {
  ...
  function instanceLevelProperty(
    propId,
    piStore,
    typeLevelCompare,
    dirtyBoundingInfo,
    ...
    return SmartPropertyBase._hookProperty(
      propId,
      piStore,
      Prim2DPropInfo.PROPKIND_INSTANCE,
      {
        typeLevelCompare: typeLevelCompare,
        dirtyBoundingInfo: dirtyBoundingInfo,
        dirtyParentBoundingBox: dirtyParentBoundingBox,
...
(function(BABYLON) {
  ...
  var PrimitivePointerInfo = (function() {
    ...
    PrimitivePointerInfo.prototype.updateRelatedTarget = function(
      prim,
      primPointerPos
    ) {
  ...
  var PrimitiveAlignment = (PrimitiveAlignment_1 = (function() {
    ...
    Object.defineProperty(PrimitiveAlignment, 'AlignLeft', {
      /**
             ...
             */
      get: function() {
        return PrimitiveAlignment_1._AlignLeft;
      },
      enumerable: true,
      configurable: true,
    });
    Object.defineProperty(PrimitiveAlignment, 'AlignTop', {
      /**
             ...
             */
      get: function() {
        return PrimitiveAlignment_1._AlignTop;
      },
      enumerable: true,
      configurable: true,
    });
    Object.defineProperty(PrimitiveAlignment, 'AlignRight', {
      /**
             ...
             */
      get: function() {
        return PrimitiveAlignment_1._AlignRight;
      },
      enumerable: true,
      configurable: true,
    });
    Object.defineProperty(PrimitiveAlignment, 'AlignBottom', {
      /**
             ...
             */
      get: function() {
        return PrimitiveAlignment_1._AlignBottom;
      },
      enumerable: true,
      configurable: true,
    });
    Object.defineProperty(PrimitiveAlignment, 'AlignCenter', {
      /**
             ...
             */
      get: function() {
        return PrimitiveAlignment_1._AlignCenter;
      },
      enumerable: true,
      configurable: true,
    });
    Object.defineProperty(PrimitiveAlignment, 'AlignStretch', {
      /**
             ...
             */
      get: function() {
        return PrimitiveAlignment_1._AlignStretch;
      },
      enumerable: true,
      configurable: true,
    });
  ...
  var PrimitiveThickness = (PrimitiveThickness_1 = (function() {
    ...
    PrimitiveThickness.prototype.fromString = function(thickness) {
      ...
      if (!res) {
        throw new Error(
          "Can't parse the string to create a PrimitiveMargin object, format must be: 'top: <value>, left:<value>, right:<value>, bottom:<value>"
        );
      }
    ...
    /**
         ...
         */
    PrimitiveThickness.prototype.fromStrings = function(
      top,
      left,
      right,
      bottom
    ...
    /**
         ...
         */
    PrimitiveThickness.prototype.fromPixels = function(
      top,
      left,
      right,
      bottom
    ...
    PrimitiveThickness.prototype.auto = function() {
      this._clear();
      this._flags =
        (PrimitiveThickness_1.Auto << 0) |
        (PrimitiveThickness_1.Auto << 4) |
        (PrimitiveThickness_1.Auto << 8) |
        (PrimitiveThickness_1.Auto << 12);
      this._pixels[0] = 0;
      this._pixels[1] = 0;
      this._pixels[2] = 0;
      this._pixels[3] = 0;
    ...
    PrimitiveThickness.prototype._setStringValue = function(
      value,
      index,
      emitChanged
    ) {
      ...
      if (v === 'auto') {
        ...
        if (pI !== -1) {
          ...
          if (
            this._isType(index, PrimitiveThickness_1.Percentage) &&
        ...
        var number = Number(n);
        if (
          this._isType(index, PrimitiveThickness_1.Pixel) &&
    ...
    PrimitiveThickness.prototype._setPixels = function(
      value,
      index,
      emitChanged
    ) {
    ...
    PrimitiveThickness.prototype._setPercentage = function(
      value,
      index,
      emitChanged
    ) {
    ...
    PrimitiveThickness.prototype._computePixels = function(
      index,
      sourceArea,
      emitChanged
    ) {
      ...
      var pixels =
        (index === 0 || index === 3 ? sourceArea.height : sourceArea.width) *
        this._percentages[index];
    ...
    /**
         ...
         */
    PrimitiveThickness.prototype.computeWithAlignment = function(
      sourceArea,
      contentSize,
      alignment,
      contentScale,
      ...
      if (computeAxis === void 0) {
        computeAxis = PrimitiveThickness_1.ComputeAll;
      }
      // Fetch some data
        ...
        switch (alignment.horizontal) {
          ...
          case PrimitiveAlignment.AlignStretch: {
            ...
            if (computeLayoutArea) {
              ...
              dstArea.width =
                sourceArea.width * isx - (dstOffset.x + rightPixels) * isx;
            }
          ...
          case PrimitiveAlignment.AlignCenter: {
            ...
            if (computeLayoutArea) {
              dstArea.width =
                width * isx + (this.leftPixels + this.rightPixels) * isx;
            } else {
              dstArea.width = width * isx;
            }
    ...
    /**
         ...
         */
    PrimitiveThickness.prototype.compute = function(
      sourceArea,
      dstOffset,
      dstArea,
      computeLayoutArea
    ...
    /**
         ...
         */
    PrimitiveThickness.prototype.computeArea = function(
      sourceArea,
      sourceScale,
      result
    ) {
      ...
      this._computePixels(3, sourceArea, true);
      result.width =
        this.leftPixels + sourceArea.width * sourceScale.x + this.rightPixels;
      result.height =
        this.bottomPixels + sourceArea.height * sourceScale.y + this.topPixels;
    };
    PrimitiveThickness.prototype.enlarge = function(
      sourceArea,
      sourceScale,
      dstOffset,
      enlargedArea
      ...
      dstOffset.x = this.leftPixels;
      enlargedArea.width =
        sourceArea.width * sourceScale.x + (dstOffset.x + this.rightPixels);
      dstOffset.y = this.bottomPixels;
      enlargedArea.height =
        sourceArea.height * sourceScale.y + (dstOffset.y + this.topPixels);
      dstOffset.z = this.rightPixels;
      dstOffset.w = this.topPixels;
    };
  ...
  var IntersectInfo2D = (function() {
    ...
    Object.defineProperty(IntersectInfo2D.prototype, 'isIntersected', {
      ...
      get: function() {
        return (
          this.intersectedPrimitives && this.intersectedPrimitives.length > 0
        );
      },
      enumerable: true,
      configurable: true,
  ...
  var Prim2DBase = (Prim2DBase_1 = (function(_super) {
    ...
    function Prim2DBase(settings) {
          ...
          if (!owner) {
            throw new Error(
              'Parent ' +
                ...
                ' of ' +
                settings.id +
                " doesn't have a valid owner!"
            );
          }
          if (
            !(_this instanceof BABYLON.Group2D) &&
            !(
              _this instanceof BABYLON.Sprite2D &&
              settings.id != null &&
              settings.id.indexOf('__cachedSpriteOfGroup__') === 0
            ) &&
            owner.cachingStrategy ===
              BABYLON.Canvas2D.CACHESTRATEGY_TOPLEVELGROUPS &&
            parent === owner
          ) {
            throw new Error(
              "Can't create a primitive with the canvas as direct parent when the caching strategy is TOPLEVELGROUPS. You need to create a Group below the canvas and use it as the parent for the primitive"
            );
          }
        }
      }
      ...
      _this._levelBoundingInfo.worldMatrixAccess = function() {
        return _this.globalTransform;
      };
      _this._boundingInfo.worldMatrixAccess = function() {
        return _this.globalTransform;
      };
      var isPickable = true;
      ...
      _this._setFlags(
        (isPickable ? BABYLON.SmartPropertyPrim.flagIsPickable : 0) |
          BABYLON.SmartPropertyPrim.flagBoundingInfoDirty |
          BABYLON.SmartPropertyPrim.flagActualOpacityDirty |
          (isContainer ? BABYLON.SmartPropertyPrim.flagIsContainer : 0) |
          BABYLON.SmartPropertyPrim.flagActualScaleDirty |
          BABYLON.SmartPropertyPrim.flagLayoutBoundingInfoDirty
      );
      ...
      if (settings.layoutEngine != null) {
        if (typeof settings.layoutEngine === 'string') {
          ...
          if (name_1 === 'canvas' || name_1 === 'canvaslayoutengine') {
            ...
            name_1.indexOf('stackpanel') === 0 ||
            name_1.indexOf('horizontalstackpanel') === 0
          ) {
      ...
      if (settings.levelCollision || settings.deepCollision) {
        _this._actorInfo = _this.owner._primitiveCollisionManager._addActor(
          _this,
          settings.deepCollision === true
        );
    ...
    Object.defineProperty(Prim2DBase.prototype, 'actualX', {
      ...
      set: function(val) {
        ...
        this._triggerPropertyChanged(
          Prim2DBase_1.actualPositionProperty,
    ...
    Object.defineProperty(Prim2DBase.prototype, 'x', {
      ...
      set: function(value) {
        ...
        if (value == null) {
          throw new Error(
            "Can't set a null x in primitive " +
              this.id +
              ', only the position can be turned to null'
          );
        }
        if (this._checkUseMargin()) {
          switch (this.marginAlignment.horizontal) {
    ...
    Object.defineProperty(Prim2DBase.prototype, 'y', {
      ...
      set: function(value) {
        ...
        if (value == null) {
          throw new Error(
            "Can't set a null y in primitive " +
              this.id +
              ', only the position can be turned to null'
          );
        }
    ...
    Prim2DBase.prototype.internalGetSize = function() {
      if (
        ...
        if (bbr !== -1 && bbr <= (this.hierarchyDepth || 0)) {
          BABYLON.C2DLogging.setPostMessage(function() {
            return 're entrancy detected';
          });
    ...
    Object.defineProperty(Prim2DBase.prototype, 'actualWidth', {
      ...
      set: function(val) {
        ...
        this._triggerPropertyChanged(
          Prim2DBase_1.actualSizeProperty,
          this._actualSize
        );
      },
      enumerable: true,
    ...
    Object.defineProperty(Prim2DBase.prototype, 'zOrder', {
      ...
      set: function(value) {
        ...
        if (
          this._actualZOrderChangedObservable &&
          this._actualZOrderChangedObservable.hasObservers()
        ) {
    ...
    Object.defineProperty(Prim2DBase.prototype, '_hasMargin', {
      ...
      get: function() {
        return (
          (this._margin !== null && !this._margin.isDefault) ||
          (this._marginAlignment !== null && !this._marginAlignment.isDefault)
        );
      },
      enumerable: true,
      configurable: true,
    ...
    Object.defineProperty(Prim2DBase.prototype, 'actualScale', {
      ...
      get: function() {
        if (this._isFlagSet(BABYLON.SmartPropertyPrim.flagActualScaleDirty)) {
          var cur = this._isFlagSet(
            BABYLON.SmartPropertyPrim.flagDontInheritParentScale
          )
            ? null
            : this.parent;
          var sx = this.scaleX;
    ...
    Object.defineProperty(Prim2DBase.prototype, 'layoutArea', {
      ...
      set: function(val) {
        ...
        if (this.parent) {
          this.parent._setFlags(
            BABYLON.SmartPropertyPrim.flagLayoutBoundingInfoDirty |
              BABYLON.SmartPropertyPrim.flagGlobalTransformDirty
          );
        }
        if (!this._layoutArea) {
      ...
      get: function() {
        if (
          ...
          this._globalTransformProcessStep !==
            this.owner._globalTransformProcessStep
        ) {
        ...
        if (this._isFlagSet(BABYLON.SmartPropertyPrim.flagBoundingInfoDirty)) {
          ...
          if (this._children.length > 0) {
            ...
            for (var _i = 0, _a = this._children; _i < _a.length; _i++) {
              ...
              if (
                curChild._isFlagSet(
                  BABYLON.SmartPropertyPrim.flagNoPartOfLayout
                )
              ) {
                continue;
              }
            ...
            if (this._hasPadding) {
              ...
              this._paddingOffset.copyFromFloats(
                padding.leftPixels,
              ...
              this._getActualSizeFromContentToRef(
                size,
                this._paddingOffset,
                size
              );
              ...
              BABYLON.BoundingInfo2D.CreateFromMinMaxToRef(
                minmax.x,
                minmax.z,
                minmax.y,
                minmax.w,
          ...
          if (
            sizedByContent ||
            !this._isFlagSet(
              BABYLON.SmartPropertyPrim.flagLevelBoundingInfoDirty
            )
          ) {
    ...
    Object.defineProperty(Prim2DBase.prototype, 'layoutBoundingInfo', {
      /**
             ...
             */
      get: function() {
        var usePositioning = this._isFlagSet(
          BABYLON.SmartPropertyPrim.flagUsePositioning
        );
        if (
          this._isFlagSet(BABYLON.SmartPropertyPrim.flagLayoutBoundingInfoDirty)
        ) {
          BABYLON.C2DLogging.setPostMessage(function() {
            return 'cache miss';
          });
          ...
          if (usePositioning) {
            if (
              this._isFlagSet(BABYLON.SmartPropertyPrim.flagPositioningDirty)
            ) {
              this._updatePositioning();
            }
            ...
            if (!this._layoutBoundingInfo) {
              BABYLON.C2DLogging.setPostMessage(function() {
                return 're entrance detected, boundingInfo returned';
              });
            ...
            if (
              ...
              BABYLON.C2DLogging.setPostMessage(function() {
                return "couldn't compute positioning, boundingInfo returned";
              });
              return this.boundingInfo;
            }
          }
          if (!usePositioning) {
            ...
            if (
              !this._isFlagSet(BABYLON.SmartPropertyPrim.flagBoundingInfoDirty)
            ) {
              this._clearFlags(
                BABYLON.SmartPropertyPrim.flagLayoutBoundingInfoDirty
              );
    ...
    Object.defineProperty(
      Prim2DBase.prototype,
      'zActualOrderChangedObservable',
      {
        get: function() {
    ...
    Object.defineProperty(Prim2DBase.prototype, 'displayDebugAreas', {
      ...
      set: function(value) {
        ...
        if (value === false) {
          ...
          this._debugAreaGroup._setFlags(
            BABYLON.SmartPropertyPrim.flagNoPartOfLayout
          );
    ...
    Prim2DBase.prototype._updateDebugArea = function() {
      ...
      for (var i = 0; i < 4; i++) {
        prims[i] = new Array(6);
        for (var j = 0; j < 6; j++) {
          prims[i][j] = this._debugAreaGroup.findById(
            '###' + areaNames[i] + ' ' + areaZones[j] + '###'
          );
          if (j > 1) {
      ...
      var actualSize = this.actualSize.multiplyByFloats(
        isCanvas ? 1 : this.scaleX,
        isCanvas ? 1 : this.scaleY
      );
      var w = hasLayout
        ? this.layoutAreaPos.x + this.layoutArea.width
        : marginH + actualSize.width;
      var h = hasLayout
        ? this.layoutAreaPos.y + this.layoutArea.height
        : marginV + actualSize.height;
      var pos =
        !hasLayout && !hasMargin && !hasPadding && hasPos
          ? this.actualPosition
          : BABYLON.Vector2.Zero();
      ...
      if (hasLayout) {
        ...
        storeAreaInfo(
          layoutOffset,
          hasMargin || hasPadding ? this.layoutArea.clone() : actualSize.clone()
        );
    ...
    Prim2DBase.prototype.intersect = function(intersectInfo) {
      ...
      if (firstLevel) {
        ...
        this.globalTransform.transformPointToRef(
          intersectInfo.pickPosition,
          intersectInfo._globalPickPosition
        );
      ...
      if (
        !Prim2DBase_1._bypassGroup2DExclusion &&
        this instanceof BABYLON.Group2D &&
        this.isCachedGroup &&
        !this.isRenderableGroup
      ) {
      ...
      if (
        isIntersectionTest &&
        !this.levelBoundingInfo.doesIntersect(intersectInfo._localPickPosition)
      ) {
        // Important to call this before each return to allow a good recursion next time this intersectInfo is reused
        intersectInfo._exit(firstLevel);
        return false;
      ...
      if (
        this.isPickable &&
        !this.boundingInfo.doesIntersect(intersectInfo._localPickPosition)
      ) {
        if (this.isContainer) {
          // Important to call this before each return to allow a good recursion next time this intersectInfo is reused
          intersectInfo._exit(firstLevel);
      ...
      if (this.isPickable) {
        levelIntersectRes =
          boundingIntersected && this.levelIntersect(intersectInfo);
        if (levelIntersectRes) {
          var pii = new PrimitiveIntersectedInfo(
            this,
            intersectInfo._localPickPosition.clone()
          );
          intersectInfo.intersectedPrimitives.push(pii);
          if (
            !intersectInfo.topMostIntersectedPrimitive ||
            intersectInfo.topMostIntersectedPrimitive.prim.actualZOffset >
              pii.prim.actualZOffset
          ) {
      ...
      if (!levelIntersectRes || !intersectInfo.findFirstOnly) {
        for (var _i = 0, _a = this._children; _i < _a.length; _i++) {
          ...
          if (
            (!curChild.isPickable && curChild.isContainer) ||
            (!intersectInfo.intersectHidden && !curChild.isVisible)
          ) {
            continue;
          }
          // Must compute the localPickLocation for the children level
          curChild.invGlobalTransform.transformPointToRef(
            intersectInfo._globalPickPosition,
            intersectInfo._localPickPosition
          );
          // If we got an intersection with the child and we only need to find the first one, quit!
          if (
            curChild.intersect(intersectInfo) &&
            intersectInfo.findFirstOnly
          ) {
            intersectInfo._exit(firstLevel);
            return true;
          }
    ...
    Prim2DBase.prototype.intersectOtherPrim = function(other) {
      ...
      return BABYLON.Tri2DArray.doesIntersect(
        setA,
        setB,
        other.globalTransform.multiply(this.globalTransform.clone().invert())
      );
    };
    ...
    Prim2DBase.prototype.moveChild = function(child, previous) {
      ...
      if (!this._isFlagSet(BABYLON.SmartPropertyPrim.flagChildrenFlatZOrder)) {
        ...
        this._firstZDirtyIndex = Math.min(
          this._firstZDirtyIndex,
          prevIndex + 1
        );
      }
      this._children.splice(
        prevIndex + 1,
        0,
        this._children.splice(childIndex, 1)[0]
      );
      return true;
    };
    /**
    ...
    Prim2DBase.prototype.addChild = function(child) {
      child._parent = this;
      this._boundingBoxDirty();
      var flat = this._isFlagSet(
        BABYLON.SmartPropertyPrim.flagChildrenFlatZOrder
      );
      if (flat) {
        ...
        if (this instanceof BABYLON.Group2D) {
          ...
          if (g.isRenderableGroup) {
            ...
            if (parentRenderable != null) {
              var l =
                parentRenderable._renderableData._childrenRenderableGroups;
              var i_1 = l.indexOf(g);
              if (i_1 !== -1) {
                l.splice(i_1, 1);
              }
    ...
    Prim2DBase.prototype.onPrimBecomesDirty = function() {
      if (
        this._renderGroup &&
        !this._isFlagSet(BABYLON.SmartPropertyPrim.flagPrimInDirtyList)
      ) {
    ...
    Prim2DBase.prototype._needPrepare = function() {
      return (
        this._areSomeFlagsSet(
          BABYLON.SmartPropertyPrim.flagVisibilityChanged |
            BABYLON.SmartPropertyPrim.flagModelDirty |
            BABYLON.SmartPropertyPrim.flagModelUpdate |
            BABYLON.SmartPropertyPrim.flagNeedRefresh
        ) ||
        this._instanceDirtyFlags !== 0 ||
        this._globalTransformProcessStep !== this._globalTransformStep
      );
    };
    ...
    Prim2DBase.prototype._updateLocalTransform = function() {
      var tflags =
        Prim2DBase_1.actualPositionProperty.flagId |
        Prim2DBase_1.rotationProperty.flagId |
        Prim2DBase_1.scaleProperty.flagId |
        Prim2DBase_1.scaleXProperty.flagId |
        Prim2DBase_1.scaleYProperty.flagId |
        Prim2DBase_1.originProperty.flagId;
      if (
        this.checkPropertiesDirty(tflags) ||
        this._areSomeFlagsSet(
          BABYLON.SmartPropertyPrim.flagLocalTransformDirty |
            BABYLON.SmartPropertyPrim.flagPositioningDirty
        )
      ) {
        if (this.owner) {
        ...
        var pos = this._position
          ? this.position
          : this.layoutAreaPos || Prim2DBase_1._v0;
        ...
        //}
        var globalScale = this._scale.multiplyByFloats(
          /*postScale.x**/ canvasScale.x,
          /*postScale.y**/ canvasScale.y
        );
        if ((this._origin.x === 0 && this._origin.y === 0) || this._hasMargin) {
          local = BABYLON.Matrix2D.Compose(
            globalScale,
            rot,
            new BABYLON.Vector2(
              pos.x + this._marginOffset.x,
              pos.y + this._marginOffset.y
            )
          );
          this._localTransform = local;
          this._localLayoutTransform = BABYLON.Matrix2D.Compose(
            globalScale,
            rot,
            new BABYLON.Vector2(pos.x, pos.y)
          );
        } else {
          // -Origin offset
          ...
          BABYLON.Matrix2D.TranslationToRef(
            -as.width * this._origin.x,
            -as.height * this._origin.y,
            t0
          );
          // -Origin * rotation
    ...
    Prim2DBase.prototype.updateCachedStates = function(recurse) {
      ...
      if (
        this._parent &&
        (this._parent._globalTransformProcessStep !==
          this.owner._globalTransformProcessStep ||
          this._parent._areSomeFlagsSet(
            BABYLON.SmartPropertyPrim.flagLayoutDirty |
              BABYLON.SmartPropertyPrim.flagPositioningDirty |
              BABYLON.SmartPropertyPrim.flagZOrderDirty
          ))
      ) {
      ...
      var sizeDirty = this.checkPropertiesDirty(
        Prim2DBase_1.sizeProperty.flagId
      );
      if (
        !this._isFlagSet(BABYLON.SmartPropertyPrim.flagLayoutDirty) &&
        !this._isFlagSet(BABYLON.SmartPropertyPrim.flagPositioningDirty) &&
        sizeDirty
      ) {
        var size = this.size;
        this.onPropertyChanged(
          ...
          size,
          size,
          Prim2DBase_1.actualSizeProperty.flagId
        );
        this.clearPropertiesDirty(Prim2DBase_1.sizeProperty.flagId);
      }
      var positioningDirty = this._isFlagSet(
        BABYLON.SmartPropertyPrim.flagPositioningDirty
      );
      var positioningComputed =
        positioningDirty &&
        !this._isFlagSet(BABYLON.SmartPropertyPrim.flagPositioningDirty);
      ...
      if (
        ...
        (autoContentChanged ||
          ...
          this._isFlagSet(BABYLON.SmartPropertyPrim.flagPositioningDirty) ||
          (this._parent &&
            !this._parent.contentArea.equals(this._parentContentArea)))
      ) {
        this._updatePositioning();
        if (sizeDirty) {
          this.clearPropertiesDirty(Prim2DBase_1.sizeProperty.flagId);
      ...
      if (
        ...
        this.isVisible =
          (!this._parent || this._parent.isVisible) && this.levelVisible;
        // Detect a change of visibility
        this._changeFlags(
          BABYLON.SmartPropertyPrim.flagVisibilityChanged,
          curVisibleState !== this.isVisible
        );
        ...
        if (this._parent) {
          parentPaddingOffset = new BABYLON.Vector2(
            this._parent._paddingOffset.x,
            this._parent._paddingOffset.y
          );
          parentPaddingChanged = !parentPaddingOffset.equals(
            this._parentPaddingOffset
          );
        }
        // Check if there are changes in the parent that will force us to update the global matrix
        var parentDirty =
          this._parent != null
            ? this._parent._globalTransformStep !== this._parentTransformStep
            : false;
        ...
        if (
          ...
          localDirty ||
          parentDirty ||
          parentPaddingChanged ||
          this._areSomeFlagsSet(
            BABYLON.SmartPropertyPrim.flagGlobalTransformDirty
          )
        ) {
          var globalTransform = this._parent
            ? this._parent._globalTransform
            : null;
          ...
          this._globalTransform = this._parent
            ? localTransform.multiply(globalTransform)
            : localTransform.clone();
          this._invGlobalTransform = BABYLON.Matrix2D.Invert(
            this._globalTransform
          );
          this._levelBoundingInfo.dirtyWorldAABB();
          this._boundingInfo.dirtyWorldAABB();
          this._globalTransformStep =
            this.owner._globalTransformProcessStep + 1;
          this._parentTransformStep = this._parent
            ? this._parent._globalTransformStep
            : 0;
      ...
      if (recurse) {
        for (var _i = 0, _a = this._children; _i < _a.length; _i++) {
          ...
          child.updateCachedStates(
            !(child instanceof BABYLON.Group2D && child.isRenderableGroup)
          );
        }
      }
    };
    Prim2DBase.prototype._updatePositioning = function() {
      if (!this._isFlagSet(BABYLON.SmartPropertyPrim.flagUsePositioning)) {
        BABYLON.C2DLogging.setPostMessage(function() {
          return 'Not using positioning engine';
        });
      ...
      if (
        this._isFlagSet(
          BABYLON.SmartPropertyPrim.flagComputingPositioning
        ) /* || (hasMargin && !this._layoutArea)*/
      ) {
        if (!this._actualSize) {
      ...
      try {
        ...
        var ma = this._marginAlignment
          ? this._marginAlignment.clone()
          : new PrimitiveAlignment();
        ...
        if (
          !this._hasMarginAlignment &&
          (isSizeAuto &&
            (primSize === Prim2DBase_1.nullSize ||
              (primSize === this._internalSize &&
                primSize.width === 0 &&
                primSize.height === 0)))
        ) {
        ...
        if (hasMargin) {
          ...
          if (
            layoutArea /*&& layoutArea.width >= size.width */ &&
            ma.horizontal === PrimitiveAlignment.AlignStretch
          ) {
            this.margin.computeWithAlignment(
              layoutArea,
              primSize,
              ma,
              levelScale,
              ...
              primNewSize,
              false,
              PrimitiveThickness.ComputeH
            );
            hasH = true;
            setSize = true;
          }
          if (
            layoutArea /*&& layoutArea.height >= size.height */ &&
            ma.vertical === PrimitiveAlignment.AlignStretch
          ) {
            this.margin.computeWithAlignment(
              layoutArea,
        ...
        if (hasMargin) {
          ...
          if (
            layoutArea &&
            layoutArea.width >= transformedBSize.width &&
            layoutArea.height >= transformedBSize.height
          ) {
            margin.computeWithAlignment(
              layoutArea,
              transformedBSize,
              ma,
              levelScale,
        ...
        this.actualPosition = new BABYLON.Vector2(
          this._marginOffset.x + (lap ? lap.x : 0),
          this._marginOffset.y + (lap ? lap.y : 0)
        );
        //                if (setSize) {
    ...
    Prim2DBase.prototype._patchHierarchy = function(owner) {
      ...
      if (this instanceof BABYLON.Group2D) {
        ...
        if (
          group._trackedNode &&
          !group._isFlagSet(BABYLON.SmartPropertyPrim.flagTrackedGroup)
        ) {
    ...
    Prim2DBase.prototype._updateZOrder = function() {
      ...
      var zDelta =
        ...
        (Prim2DBase_1._totalCount *
          (Prim2DBase_1._zRebuildReentrency ? 1 : 1.2));
      ...
      if (zDelta < BABYLON.Canvas2D._zMinDelta) {
        ...
        if (Prim2DBase_1._zRebuildReentrency) {
          ...
          if (p == null) {
            ...
            console.log(
              "Can't compute Z-Order for " +
                this.id +
                "'s children, zDelta is too small, Z-Order is now in an unstable state"
            );
      ...
      for (
        var _i = 0, _a = Prim2DBase_1._zOrderChangedNotifList;
        _i < _a.length;
        _i++
      ) {
        var p = _a[_i];
    ...
    Prim2DBase.prototype._updatePrimitiveZOrder = function(
      startPos,
      startZ,
      deltaZ
    ) {
    ...
    /**
         ...
         */
    Prim2DBase.prototype._getInitialContentAreaToRef = function(
      primSize,
    ...
    /**
         ...
         */
    Prim2DBase.prototype._getActualSizeFromContentToRef = function(
      primSize,
      paddingOffset,
      newPrimSize
    ) {
  ...
  __decorate(
    [
      ...
      BABYLON.instanceLevelProperty(
        1,
        function(pi) {
          return (Prim2DBase_1.actualPositionProperty = pi);
        },
        false,
        false,
        true
  ...
  __decorate(
    [
      BABYLON.instanceLevelProperty(
        BABYLON.SmartPropertyPrim.SMARTPROPERTYPRIM_PROPCOUNT + 1,
        function(pi) {
          return (Prim2DBase_1.actualXProperty = pi);
        },
        false,
        false,
        true
  ...
  __decorate(
    [
      BABYLON.instanceLevelProperty(
        BABYLON.SmartPropertyPrim.SMARTPROPERTYPRIM_PROPCOUNT + 2,
        function(pi) {
          return (Prim2DBase_1.actualYProperty = pi);
        },
        false,
        false,
        true
  ...
  __decorate(
    [
      BABYLON.dynamicLevelProperty(
        BABYLON.SmartPropertyPrim.SMARTPROPERTYPRIM_PROPCOUNT + 3,
        function(pi) {
          return (Prim2DBase_1.positionProperty = pi);
        },
        false,
        false,
        true
  ...
  __decorate(
    [
      BABYLON.dynamicLevelProperty(
        BABYLON.SmartPropertyPrim.SMARTPROPERTYPRIM_PROPCOUNT + 4,
        function(pi) {
          return (Prim2DBase_1.xProperty = pi);
        },
        false,
        false,
        true
  ...
  __decorate(
    [
      BABYLON.dynamicLevelProperty(
        BABYLON.SmartPropertyPrim.SMARTPROPERTYPRIM_PROPCOUNT + 5,
        function(pi) {
          return (Prim2DBase_1.yProperty = pi);
        },
        false,
        false,
        true
  ...
  __decorate(
    [
      BABYLON.logProp(),
      BABYLON.dynamicLevelProperty(
        BABYLON.SmartPropertyPrim.SMARTPROPERTYPRIM_PROPCOUNT + 6,
        function(pi) {
          return (Prim2DBase_1.sizeProperty = pi);
        },
        false,
        true
      ),
  ...
  __decorate(
    [
      BABYLON.logProp(),
      BABYLON.dynamicLevelProperty(
        BABYLON.SmartPropertyPrim.SMARTPROPERTYPRIM_PROPCOUNT + 7,
        function(pi) {
          return (Prim2DBase_1.widthProperty = pi);
        },
        false,
        true
      ),
  ...
  __decorate(
    [
      BABYLON.logProp(),
      BABYLON.dynamicLevelProperty(
        BABYLON.SmartPropertyPrim.SMARTPROPERTYPRIM_PROPCOUNT + 8,
        function(pi) {
          return (Prim2DBase_1.heightProperty = pi);
        },
        false,
        true
      ),
  ...
  __decorate(
    [
      BABYLON.logProp(),
      BABYLON.instanceLevelProperty(
        BABYLON.SmartPropertyPrim.SMARTPROPERTYPRIM_PROPCOUNT + 9,
        function(pi) {
          return (Prim2DBase_1.rotationProperty = pi);
        },
        false,
        true
      ),
  ...
  __decorate(
    [
      BABYLON.logProp(),
      BABYLON.instanceLevelProperty(
        BABYLON.SmartPropertyPrim.SMARTPROPERTYPRIM_PROPCOUNT + 10,
        function(pi) {
          return (Prim2DBase_1.scaleProperty = pi);
        },
        false,
        true
      ),
  ...
  __decorate(
    [
      BABYLON.logProp(),
      BABYLON.dynamicLevelProperty(
        BABYLON.SmartPropertyPrim.SMARTPROPERTYPRIM_PROPCOUNT + 11,
        function(pi) {
          return (Prim2DBase_1.actualSizeProperty = pi);
        },
        false,
        true
      ),
  ...
  __decorate(
    [
      BABYLON.dynamicLevelProperty(
        BABYLON.SmartPropertyPrim.SMARTPROPERTYPRIM_PROPCOUNT + 12,
        function(pi) {
          return (Prim2DBase_1.actualWidthProperty = pi);
        },
        false,
        true
      ),
  ...
  __decorate(
    [
      BABYLON.dynamicLevelProperty(
        BABYLON.SmartPropertyPrim.SMARTPROPERTYPRIM_PROPCOUNT + 13,
        function(pi) {
          return (Prim2DBase_1.actualHeightProperty = pi);
        },
        false,
        true
      ),
  ...
  __decorate(
    [
      BABYLON.dynamicLevelProperty(
        BABYLON.SmartPropertyPrim.SMARTPROPERTYPRIM_PROPCOUNT + 14,
        function(pi) {
          return (Prim2DBase_1.originProperty = pi);
        },
        false,
        true
      ),
  ...
  __decorate(
    [
      BABYLON.dynamicLevelProperty(
        BABYLON.SmartPropertyPrim.SMARTPROPERTYPRIM_PROPCOUNT + 15,
        function(pi) {
          return (Prim2DBase_1.levelVisibleProperty = pi);
        }
      ),
    ],
    Prim2DBase.prototype,
  ...
  __decorate(
    [
      BABYLON.instanceLevelProperty(
        BABYLON.SmartPropertyPrim.SMARTPROPERTYPRIM_PROPCOUNT + 16,
        function(pi) {
          return (Prim2DBase_1.isVisibleProperty = pi);
        }
      ),
    ],
    Prim2DBase.prototype,
  ...
  __decorate(
    [
      BABYLON.instanceLevelProperty(
        BABYLON.SmartPropertyPrim.SMARTPROPERTYPRIM_PROPCOUNT + 17,
        function(pi) {
          return (Prim2DBase_1.zOrderProperty = pi);
        }
      ),
    ],
    Prim2DBase.prototype,
  ...
  __decorate(
    [
      BABYLON.dynamicLevelProperty(
        BABYLON.SmartPropertyPrim.SMARTPROPERTYPRIM_PROPCOUNT + 18,
        function(pi) {
          return (Prim2DBase_1.marginProperty = pi);
        }
      ),
    ],
    Prim2DBase.prototype,
  ...
  __decorate(
    [
      BABYLON.dynamicLevelProperty(
        BABYLON.SmartPropertyPrim.SMARTPROPERTYPRIM_PROPCOUNT + 19,
        function(pi) {
          return (Prim2DBase_1.paddingProperty = pi);
        }
      ),
    ],
    Prim2DBase.prototype,
  ...
  __decorate(
    [
      BABYLON.dynamicLevelProperty(
        BABYLON.SmartPropertyPrim.SMARTPROPERTYPRIM_PROPCOUNT + 20,
        function(pi) {
          return (Prim2DBase_1.marginAlignmentProperty = pi);
        }
      ),
    ],
    Prim2DBase.prototype,
  ...
  __decorate(
    [
      BABYLON.instanceLevelProperty(
        BABYLON.SmartPropertyPrim.SMARTPROPERTYPRIM_PROPCOUNT + 21,
        function(pi) {
          return (Prim2DBase_1.opacityProperty = pi);
        }
      ),
    ],
    Prim2DBase.prototype,
  ...
  __decorate(
    [
      BABYLON.instanceLevelProperty(
        BABYLON.SmartPropertyPrim.SMARTPROPERTYPRIM_PROPCOUNT + 22,
        function(pi) {
          return (Prim2DBase_1.scaleXProperty = pi);
        },
        false,
        true
      ),
  ...
  __decorate(
    [
      BABYLON.instanceLevelProperty(
        BABYLON.SmartPropertyPrim.SMARTPROPERTYPRIM_PROPCOUNT + 23,
        function(pi) {
          return (Prim2DBase_1.scaleYProperty = pi);
        },
        false,
        true
      ),
  ...
  __decorate(
    [
      BABYLON.instanceLevelProperty(
        BABYLON.SmartPropertyPrim.SMARTPROPERTYPRIM_PROPCOUNT + 24,
        function(pi) {
          return (Prim2DBase_1.actualScaleProperty = pi);
        },
        false,
        true
      ),
...
(function(BABYLON) {
  var GroupInstanceInfo = (function() {
    ...
    GroupInstanceInfo.prototype.dispose = function() {
      ...
      this.owner._renderableData._renderGroupInstancesInfo.remove(
        this.modelRenderCache.modelKey
      );
      ...
      get: function() {
        if (!this._transparentData) {
          ...
          for (var i = 0; i < this._partCount; i++) {
            ...
            this._transparentData[i] = new TransparentGroupInfoPartData(
              this._strides[i],
              zoff
            );
          }
  ...
  var ModelRenderCache = (function() {
    ...
    ModelRenderCache.prototype.loadInstancingAttributes = function(
      partId,
      effect
    ) {
    ...
    ModelRenderCache.prototype.setupUniforms = function(
      effect,
      partIndex,
      data,
      elementCount
      ...
      pci.fullContent.forEach(function(k, v) {
        if (!v.category || pd._partUsedCategories.indexOf(v.category) !== -1) {
          switch (v.dataType) {
            case 3 /* float */: {
              var attribOffset = v.instanceOffset.get(
                pd._partJoinedUsedCategories
              );
              effect.setFloat(
                v.attributeName,
                data.buffer[offset + attribOffset]
              );
              break;
            }
            case 0 /* Vector2 */: {
...
(function(BABYLON) {
  var InstanceClassInfo = (function() {
    ...
    InstanceClassInfo.prototype.mapProperty = function(propInfo, push) {
      var curOff = this._nextOffset.getOrAdd(
        InstanceClassInfo._CurCategories,
        0
      );
      propInfo.instanceOffset.add(
        InstanceClassInfo._CurCategories,
        this._getBaseOffset(InstanceClassInfo._CurCategories) + curOff
      );
      ...
      this._nextOffset.set(
        InstanceClassInfo._CurCategories,
        curOff + propInfo.size / 4
      );
      if (push) {
        this._attributes.push(propInfo);
      }
    };
    InstanceClassInfo.prototype.getInstancingAttributeInfos = function(
      effect,
      categories
    ) {
            ...
            if (index === -1) {
              throw new Error(
                'Attribute ' +
                  ...
                  ' was not found in Effect: ' +
                  effect.name +
                  ". It's certainly no longer used in the Effect's Shaders"
              );
            }
  ...
  var InstancePropInfo = (function() {
    ...
    InstancePropInfo.prototype.setSize = function(val) {
      ...
      if (val instanceof BABYLON.Matrix2D) {
        throw new Error(
          'Matrix2D type is not supported by WebGL Instance Buffer, you have to use four Vector4 properties instead'
        );
      }
    ...
    return function(target, propName, descriptor) {
      ...
      if (info) {
        throw new Error(
          'The ID ' +
            instanceDataName +
            ' is already taken by another instance data'
        );
      }
      ...
      descriptor.set = function(val) {
        ...
        if (
          info.category &&
          InstanceClassInfo._CurCategories.indexOf(info.delimitedCategory) ===
            -1
        ) {
          return;
        }
        ...
        if (info.curCategory === InstanceClassInfo._CurCategories) {
          ...
          if (!info.size) {
            ...
            !info.instanceOffset.contains(InstanceClassInfo._CurCategories)
          ) {
  ...
  __decorate([instanceData()], InstanceDataBase.prototype, 'zBias', null);
  __decorate([instanceData()], InstanceDataBase.prototype, 'transformX', null);
  __decorate([instanceData()], InstanceDataBase.prototype, 'transformY', null);
  __decorate(
    [instanceData()],
    InstanceDataBase.prototype,
    'renderingInfo',
    null
  );
  __decorate([instanceData()], InstanceDataBase.prototype, 'opacity', null);
  ...
  var RenderablePrim2D = (RenderablePrim2D_1 = (function(_super) {
    ...
    Object.defineProperty(RenderablePrim2D.prototype, 'isTransparent', {
      get: function() {
        return (
          ...
          this._shouldUseAlphaFromTexture() ||
          this._isPrimTransparent()
        );
      },
      enumerable: true,
      configurable: true,
    ...
    RenderablePrim2D.prototype.dispose = function() {
      ...
      if (this._transparentPrimitiveInfo) {
        this.renderGroup._renderableData.removeTransparentPrimitiveInfo(
          this._transparentPrimitiveInfo
        );
    ...
    RenderablePrim2D.prototype._prepareRenderPre = function(context) {
      ...
      if (
        this._isFlagSet(BABYLON.SmartPropertyPrim.flagModelDirty) &&
        this._instanceDataParts
      ) {
        this._cleanupInstanceDataParts();
      }
      ...
      if (
        ...
        context.forceRefreshPrimitive ||
        newInstance ||
        this._instanceDirtyFlags !== 0 ||
        this._globalTransformProcessStep !== this._globalTransformStep ||
        this._mustUpdateInstance()
      ) {
    ...
    RenderablePrim2D.prototype._createModelRenderCache = function() {
      ...
      this._modelRenderCache = this.owner._engineData.GetOrAddModelCache(
        this.modelKey,
        function(key) {
    ...
    RenderablePrim2D.prototype._createModelDataParts = function() {
      ...
      var gii = this.renderGroup._renderableData._renderGroupInstancesInfo.getOrAddWithFactory(
        this.modelKey,
        function(k) {
          var res = new BABYLON.GroupInstanceInfo(
            _this.renderGroup,
            _this._modelRenderCache,
            _this._modelRenderCache._partData.length
          );
          for (var j = 0; j < _this._modelRenderCache._partData.length; j++) {
            ...
            res.usedShaderCategories[j] =
              ';' + _this.getUsedShaderCategories(part).join(';') + ';';
            res.strides[j] =
              _this._modelRenderCache._partData[j]._partDataStride;
          }
          return res;
        }
      );
      ...
      for (var _i = 0, parts_1 = parts; _i < parts_1.length; _i++) {
        ...
        if (!this.refreshInstanceDataPart(dataPart)) {
          console.log(
            'Layout construction for ' +
              BABYLON.Tools.getClassName(this._instanceDataParts[0]) +
              ' failed because refresh returned false'
          );
        }
        ...
        cti.fullContent.forEach(function(k, v) {
          if (!v.category || cat.indexOf(v.category) !== -1) {
            ...
            if (!v.size) {
              console.log(
                "ERROR: Couldn't detect the size of the Property " +
                  v.attributeName +
                  ' from type ' +
                  BABYLON.Tools.getClassName(cti.type) +
                  '. Property is ignored.'
              );
            } else {
              size += v.size;
    ...
    RenderablePrim2D.prototype.onZOrderChanged = function() {
      if (this.isTransparent && this._transparentPrimitiveInfo) {
        this.renderGroup._renderableData.transparentPrimitiveZChanged(
          this._transparentPrimitiveInfo
        );
        var gii = this.renderGroup._renderableData._renderGroupInstancesInfo.get(
          this.modelKey
        );
    ...
    RenderablePrim2D.prototype._updateInstanceDataParts = function(gii) {
      ...
      if (this._instanceDataParts.length > 0) {
        ...
        if (partRM !== curRM) {
          wereTransparent =
            partRM === BABYLON.Render2DContext.RenderModeTransparent;
          rmChanged = true;
          var gipd = void 0;
          switch (curRM) {
      ...
      var visChanged = this._isFlagSet(
        BABYLON.SmartPropertyPrim.flagVisibilityChanged
      );
        ...
        if (visChanged || rmChanged) {
          if (this.isVisible && !wereTransparent) {
            if (!this._transparentPrimitiveInfo) {
              ...
              this._transparentPrimitiveInfo = rd.addNewTransparentPrimitiveInfo(
                this,
                gii
              );
            }
      ...
      for (var _i = 0, _a = this._instanceDataParts; _i < _a.length; _i++) {
        ...
        InstanceClassInfo._CurCategories =
          gii.usedShaderCategories[gii.partIndexFromId.get(part.id.toString())];
    ...
    RenderablePrim2D.prototype._updateTransparentSegmentIndices = function(ts) {
      ...
      for (var _i = 0, _a = this._instanceDataParts; _i < _a.length; _i++) {
        ...
        if (part && part.dataElements) {
          ...
          ts.startDataIndex = Math.min(
            ts.startDataIndex,
            minOff / part.dataBuffer.stride
          );
          ts.endDataIndex = Math.max(
            ts.endDataIndex,
            maxOff / part.dataBuffer.stride + 1
          ); // +1 for exclusive
        }
      }
    };
      ...
      for (var i = 0; i < length; i++) {
        ...
        if (part) {
          ...
          var lastElementOffset =
            part.dataElements[part.dataElements.length - 1].offset;
          ...
          return part.dataBuffer[
            lastElementOffset +
              stride +
              this.modelRenderCache._partData[i]._zBiasOffset
          ];
        }
      }
      return null;
    ...
    /**
         ...
         */
    RenderablePrim2D.prototype.getDataPartEffectInfo = function(
      dataPartId,
      ...
      return {
        attributes: instancedArray
          ? vertexBufferAttributes.concat(att)
          : vertexBufferAttributes,
        uniforms: instancedArray
          ? uniforms != null ? uniforms : []
          : uniforms != null ? att.concat(uniforms) : att != null ? att : [],
        defines: defines,
      };
    };
    ...
    RenderablePrim2D.prototype.setupModelRenderCache = function(
      modelRenderCache
    ) {};
    ...
    RenderablePrim2D.prototype.beforeRefreshForLayoutConstruction = function(
      part
    ) {};
    RenderablePrim2D.prototype.afterRefreshForLayoutConstruction = function(
      part,
      obj
    ) {};
    ...
    /**
         ...
         */
    RenderablePrim2D.prototype.updateInstanceDataPart = function(
      part,
      positionOffset
    ) {
      ...
      var t = this._globalTransform.multiply(
        this.renderGroup.invGlobalTransform
      ); // Compute the transformation into the renderGroup's space
      ...
      t = BABYLON.Matrix2D.Compose(
        this.applyActualScaleOnTransform() ? scl : RenderablePrim2D_1._iV2,
        rot,
        trn
      );
      ...
      var tx = new BABYLON.Vector4(
        t.m[0] * 2 / w,
        t.m[2] * 2 / w,
        0,
        (t.m[4] + offX) * 2 / w - 1
      );
      var ty = new BABYLON.Vector4(
        t.m[1] * 2 / h,
        t.m[3] * 2 / h,
        0,
        (t.m[5] + offY) * 2 / h - 1
  ...
  RenderablePrim2D.RENDERABLEPRIM2D_PROPCOUNT =
    BABYLON.Prim2DBase.PRIM2DBASE_PROPCOUNT + 5;
  ...
  __decorate(
    [
      BABYLON.dynamicLevelProperty(
        BABYLON.Prim2DBase.PRIM2DBASE_PROPCOUNT + 0,
        function(pi) {
          return (RenderablePrim2D_1.isAlphaTestProperty = pi);
        }
      ),
    ],
    RenderablePrim2D.prototype,
    'isAlphaTest',
    null
  );
  __decorate(
    [
      BABYLON.dynamicLevelProperty(
        BABYLON.Prim2DBase.PRIM2DBASE_PROPCOUNT + 1,
        function(pi) {
          return (RenderablePrim2D_1.isTransparentProperty = pi);
        }
      ),
    ],
    RenderablePrim2D.prototype,
...
(function(BABYLON) {
  var Shape2D = (Shape2D_1 = (function(_super) {
      ...
      if (part.id === Shape2D_1.SHAPE2D_FILLPARTID) {
        ...
        if (this.fill) {
          ...
          if (fill instanceof BABYLON.SolidColorBrush2D) {
            ...
            var t = BABYLON.Matrix2D.Compose(
              new BABYLON.Vector2(fill.scale, fill.scale),
              fill.rotation,
              new BABYLON.Vector2(fill.translation.x, fill.translation.y)
            );
        ...
        if (this.border) {
          ...
          if (border instanceof BABYLON.SolidColorBrush2D) {
            ...
            var t = BABYLON.Matrix2D.Compose(
              new BABYLON.Vector2(border.scale, border.scale),
              border.rotation,
              new BABYLON.Vector2(border.translation.x, border.translation.y)
            );
            var ty = new BABYLON.Vector4(t.m[1], t.m[3], 0, t.m[5]);
    ...
    Shape2D.prototype._updateTransparencyStatus = function() {
      this._isTransparent =
        (this._border && this._border.isTransparent()) ||
        (this._fill && this._fill.isTransparent()) ||
        this.actualOpacity < 1;
  ...
  Shape2D.SHAPE2D_PROPCOUNT =
    BABYLON.RenderablePrim2D.RENDERABLEPRIM2D_PROPCOUNT + 5;
  __decorate(
    [
      BABYLON.modelLevelProperty(
        BABYLON.RenderablePrim2D.RENDERABLEPRIM2D_PROPCOUNT + 1,
        function(pi) {
          return (Shape2D_1.borderProperty = pi);
        },
        true
      ),
    ],
  ...
  __decorate(
    [
      BABYLON.modelLevelProperty(
        BABYLON.RenderablePrim2D.RENDERABLEPRIM2D_PROPCOUNT + 2,
        function(pi) {
          return (Shape2D_1.fillProperty = pi);
        },
        true
      ),
    ],
  ...
  __decorate(
    [
      BABYLON.instanceLevelProperty(
        BABYLON.RenderablePrim2D.RENDERABLEPRIM2D_PROPCOUNT + 3,
        function(pi) {
          return (Shape2D_1.borderThicknessProperty = pi);
        }
      ),
    ],
    Shape2D.prototype,
...
(function(BABYLON) {
  var Group2D = (Group2D_1 = (function(_super) {
    ...
    function Group2D(settings) {
      ...
      var size =
        !settings.size && !settings.width && !settings.height
          ? null
          : settings.size ||
            new BABYLON.Size(settings.width || 0, settings.height || 0);
      if (!(_this instanceof BABYLON.WorldSpaceCanvas2D)) {
        _this._trackedNode =
          settings.trackNode == null ? null : settings.trackNode;
        _this._trackedNodeOffset =
          settings.trackNodeOffset == null ? null : settings.trackNodeOffset;
        if (_this._trackedNode && _this.owner) {
          _this.owner._registerTrackedNode(_this);
        }
      }
      _this._cacheBehavior =
        settings.cacheBehavior == null
          ? Group2D_1.GROUPCACHEBEHAVIOR_FOLLOWCACHESTRATEGY
          : settings.cacheBehavior;
      var rd = _this._renderableData;
      if (rd) {
        rd._noResizeOnScale =
          (_this.cacheBehavior &
            Group2D_1.GROUPCACHEBEHAVIOR_NORESIZEONSCALE) !==
          0;
      }
      _this.size = size;
    ...
    Group2D.prototype._prepareGroupRender = function(context) {
      ...
      if (
        (this instanceof BABYLON.Canvas2D ||
          this.id === '__cachedCanvasGroup__') &&
        this.owner.designSize != null
      ) {
    ...
    Group2D.prototype._groupRender = function() {
      ...
      for (
        var _i = 0, _a = this._renderableData._childrenRenderableGroups;
        _i < _a.length;
        _i++
      ) {
      ...
      if (!this.isCachedGroup || this._cacheGroupDirty) {
        ...
        if (this.isCachedGroup) {
          ...
          var curVP = engine.setDirectViewport(
            this._viewportPosition.x,
            this._viewportPosition.y,
        ...
        var context_1 = new BABYLON.Render2DContext(
          BABYLON.Render2DContext.RenderModeOpaque
        );
        ...
        engine.setDepthWrite(true);
        // For each different model of primitive to render
        context_1 = new BABYLON.Render2DContext(
          BABYLON.Render2DContext.RenderModeAlphaTest
        );
        this._renderableData._renderGroupInstancesInfo.forEach(function(k, v) {
          // Prepare the context object, update the WebGL Instanced Array buffer if needed
          var renderCount = _this._prepareContext(engine, context_1, v);
    ...
    Group2D.prototype._renderTransparentData = function() {
      ...
      var context = new BABYLON.Render2DContext(
        BABYLON.Render2DContext.RenderModeTransparent
      );
      var rd = this._renderableData;
      ...
      for (var i = 0; i < length; i++) {
        ...
        if (
          useInstanced &&
          count >= this.owner.minPartCountToUseInstancedArray
        ) {
          if (!ts.partBuffers) {
            ...
            for (var j = 0; j < gii.transparentData.length; j++) {
              ...
              var segData = data.subarray(
                ts.startDataIndex * stride,
                ts.endDataIndex * stride
              );
    ...
    Group2D.prototype._prepareContext = function(engine, context, gii) {
      ...
      if (this.owner.supportInstancedArray) {
        ...
        if (context.groupInfoPartData.length > 0) {
          ...
          context.partDataEndIndex =
            context.groupInfoPartData[i]._partData.usedElementCount;
        }
      }
      return renderCount;
    };
    ...
    Group2D.prototype._bindCacheTarget = function() {
      ...
      if (noResizeScale) {
        scale = isCanvas
          ? Group2D_1._uV
          : this.parent.actualScale.multiply(this.owner._canvasLevelScale);
      } else {
      ...
      if (
        isCanvas &&
        this.owner.cachingStrategy === BABYLON.Canvas2D.CACHESTRATEGY_CANVAS &&
        this.owner.isScreenSpace
      ) {
      ...
      if (!rd._cacheNode) {
        ...
        var res = this.owner._allocateGroupCache(
          this,
          this.parent && this.parent.renderGroup,
          curWidth ? new BABYLON.Size(curWidth, curHeight) : null,
          rd._useMipMap,
          rd._anisotropicLevel
        );
        ...
        if (sprite) {
          ...
          sprite.spriteSize = new BABYLON.Size(
            actualSize.width * scale.x * rs,
            actualSize.height * scale.y * rs
          );
        }
      }
      if (sizeChanged) {
        ...
        if (
          rd._cacheNodeUVsChangedObservable &&
          rd._cacheNodeUVsChangedObservable.hasObservers()
        ) {
    ...
    Group2D.prototype.detectGroupStates = function() {
      ...
      if (canvasStrat === BABYLON.Canvas2D.CACHESTRATEGY_DONTCACHE) {
        ...
        canvasStrat === BABYLON.Canvas2D.CACHESTRATEGY_TOPLEVELGROUPS
      ) {
        if (isCanvas) {
          this._isRenderableGroup = true;
          this._isCachedGroup = false;
        ...
        if (isCanvas) {
          ...
          var gcb =
            this.cacheBehavior & Group2D_1.GROUPCACHEBEHAVIOR_OPTIONMASK;
          if (
            gcb === Group2D_1.GROUPCACHEBEHAVIOR_DONTCACHEOVERRIDE ||
            gcb === Group2D_1.GROUPCACHEBEHAVIOR_CACHEINPARENTGROUP
          ) {
            this._isRenderableGroup =
              gcb === Group2D_1.GROUPCACHEBEHAVIOR_DONTCACHEOVERRIDE;
            this._isCachedGroup = false;
          }
      ...
      if (this._isCachedGroup) {
        this._renderableData._noResizeOnScale =
          (this.cacheBehavior &
            Group2D_1.GROUPCACHEBEHAVIOR_NORESIZEONSCALE) !==
          0;
        var cur = this.parent;
        while (cur) {
          if (cur instanceof Group2D_1 && cur._isRenderableGroup) {
            if (
              cur._renderableData._childrenRenderableGroups.indexOf(this) === -1
            ) {
  ...
  __decorate(
    [
      BABYLON.instanceLevelProperty(
        BABYLON.Prim2DBase.PRIM2DBASE_PROPCOUNT + 1,
        function(pi) {
          return (Group2D_1.sizeProperty = pi);
        },
        false,
        true
      ),
  ...
  var RenderableGroupData = (function() {
    ...
    RenderableGroupData.prototype.addNewTransparentPrimitiveInfo = function(
      prim,
      gii
    ) {
    ...
    RenderableGroupData.prototype.removeTransparentPrimitiveInfo = function(
      tpi
    ) {
...
(function(BABYLON) {
    ...
    WireFrame2DRenderCache.prototype.render = function(instanceInfo, context) {
      ...
      if (!this.effectsReady) {
        if (
          this.effect &&
          (!this.effect.isReady() ||
            (this.effectInstanced && !this.effectInstanced.isReady()))
        ) {
          return false;
        }
      ...
      if (context.useInstancing) {
        if (!this.instancingAttributes) {
          this.instancingAttributes = this.loadInstancingAttributes(
            WireFrame2D.WIREFRAME2D_MAINPARTID,
            effect
          );
        }
        var glBuffer = context.instancedBuffers
          ? context.instancedBuffers[0]
          : pid._partBuffer;
        var count = context.instancedBuffers
          ? context.instancesCount
          : pid._partData.usedElementCount;
        canvas._addDrawCallCount(1, context.renderMode);
        engine.updateAndBindInstancesBuffer(
          glBuffer,
          null,
          this.instancingAttributes
        );
        engine.drawUnIndexed(false, 0, this.vtxCount, count);
        //                engine.draw(true, 0, 6, count);
        engine.unbindInstanceAttributes();
      } else {
        canvas._addDrawCallCount(
          context.partDataEndIndex - context.partDataStartIndex,
          context.renderMode
        );
        for (
          var i = context.partDataStartIndex;
          i < context.partDataEndIndex;
          i++
        ) {
  ...
  var WireFrameGroup2D = (function() {
    ...
    function WireFrameGroup2D(id, defaultColor) {
      ...
      this._uid = BABYLON.Tools.RandomId();
      this._defaultColor =
        defaultColor == null ? new BABYLON.Color4(1, 1, 1, 1) : defaultColor;
  ...
  var WireFrame2D = (WireFrame2D_1 = (function(_super) {
    ...
    function WireFrame2D(wireFrameGroups, settings) {
      ...
      for (
        var _i = 0, wireFrameGroups_1 = wireFrameGroups;
        _i < wireFrameGroups_1.length;
        _i++
      ) {
    ...
    WireFrame2D.prototype.setupModelRenderCache = function(modelRenderCache) {
      ...
      var ei = this.getDataPartEffectInfo(
        WireFrame2D_1.WIREFRAME2D_MAINPARTID,
        ['pos', 'col'],
        [],
        true
      );
      if (ei) {
        renderCache.effectInstanced = engine.createEffect(
          'wireframe2d',
          ei.attributes,
          ei.uniforms,
          [],
      ...
      ei = this.getDataPartEffectInfo(
        WireFrame2D_1.WIREFRAME2D_MAINPARTID,
        ['pos', 'col'],
        [],
        false
      );
      renderCache.effect = engine.createEffect(
        'wireframe2d',
        ei.attributes,
        ei.uniforms,
        [],
    ...
    WireFrame2D.prototype._updateVertexBuffer = function(mrc) {
      ...
      this._wireFrameGroups.forEach(function(k, v) {
        return (vtxCount += v.vertices.length);
      });
    ...
    WireFrame2D.prototype.createInstanceDataParts = function() {
      return [
        new WireFrame2DInstanceData(WireFrame2D_1.WIREFRAME2D_MAINPARTID),
      ];
    };
    return WireFrame2D;
  })(BABYLON.RenderablePrim2D));
  ...
  __decorate(
    [
      BABYLON.modelLevelProperty(
        BABYLON.RenderablePrim2D.RENDERABLEPRIM2D_PROPCOUNT + 1,
        function(pi) {
          return (WireFrame2D_1.wireFrameGroupsProperty = pi);
        }
      ),
    ],
    WireFrame2D.prototype,
    'wireFrameGroups',
    null
  );
...
(function(BABYLON) {
  var Rectangle2DRenderCache = (function(_super) {
    ...
    Rectangle2DRenderCache.prototype.render = function(instanceInfo, context) {
      ...
      if (!this.effectsReady) {
        if (
          (this.effectFill &&
            (!this.effectFill.isReady() ||
              (this.effectFillInstanced &&
                !this.effectFillInstanced.isReady()))) ||
          (this.effectBorder &&
            (!this.effectBorder.isReady() ||
              (this.effectBorderInstanced &&
                !this.effectBorderInstanced.isReady())))
        ) {
          return false;
        }
        this.effectsReady = true;
      ...
      if (this.effectFill) {
        var partIndex = instanceInfo.partIndexFromId.get(
          BABYLON.Shape2D.SHAPE2D_FILLPARTID.toString()
        );
        var pid = context.groupInfoPartData[partIndex];
        if (context.renderMode !== BABYLON.Render2DContext.RenderModeOpaque) {
          engine.setAlphaMode(BABYLON.Engine.ALPHA_COMBINE, true);
        }
        var effect = context.useInstancing
          ? this.effectFillInstanced
          : this.effectFill;
        engine.enableEffect(effect);
        ...
        if (context.useInstancing) {
          if (!this.instancingFillAttributes) {
            this.instancingFillAttributes = this.loadInstancingAttributes(
              BABYLON.Shape2D.SHAPE2D_FILLPARTID,
              effect
            );
          }
          var glBuffer = context.instancedBuffers
            ? context.instancedBuffers[partIndex]
            : pid._partBuffer;
          var count = context.instancedBuffers
            ? context.instancesCount
            : pid._partData.usedElementCount;
      ...
      if (this.effectBorder) {
        var partIndex = instanceInfo.partIndexFromId.get(
          BABYLON.Shape2D.SHAPE2D_BORDERPARTID.toString()
        );
        var pid = context.groupInfoPartData[partIndex];
        if (context.renderMode !== BABYLON.Render2DContext.RenderModeOpaque) {
          engine.setAlphaMode(BABYLON.Engine.ALPHA_COMBINE, true);
        ...
        if (context.useInstancing) {
          if (!this.instancingBorderAttributes) {
            this.instancingBorderAttributes = this.loadInstancingAttributes(
              BABYLON.Shape2D.SHAPE2D_BORDERPARTID,
              effect
            );
          }
          var glBuffer = context.instancedBuffers
  ...
  __decorate(
    ...
    Rectangle2DInstanceData.prototype,
    'properties',
    null
  );
  ...
  var Rectangle2D = (Rectangle2D_1 = (function(_super) {
    ...
    Rectangle2D.prototype.levelIntersect = function(intersectInfo) {
      ...
      if (
        Rectangle2D_1._i0.x <= Rectangle2D_1._i1.x &&
        Rectangle2D_1._i0.y <= Rectangle2D_1._i1.y
      ) {
    ...
    Rectangle2D.prototype.updateLevelBoundingInfo = function() {
      BABYLON.BoundingInfo2D.CreateFromSizeToRef(
        this.actualSize,
        this._levelBoundingInfo
      );
      return true;
    ...
    Rectangle2D.prototype.setupModelRenderCache = function(modelRenderCache) {
      ...
      if (this.fill) {
        var vbSize =
          (this.notRounded ? 1 : Rectangle2D_1.roundSubdivisions) * 4 + 1;
      ...
      if (this.border) {
        var vbSize =
          (this.notRounded ? 1 : Rectangle2D_1.roundSubdivisions) * 4 * 2;
        var vb = new Float32Array(vbSize);
        for (var i = 0; i < vbSize; i++) {
          vb[i] = i;
        }
    ...
    Rectangle2D.prototype._getInitialContentAreaToRef = function(
      primSize,
      initialContentPosition,
      initialContentArea
    ) {
      ...
      if (this._notRounded) {
        _super.prototype._getInitialContentAreaToRef.call(
          this,
          primSize,
          initialContentPosition,
          initialContentArea
        ...
        var rr = Math.round(
          (this.roundRadius - this.roundRadius / Math.sqrt(2)) * 1.3
        );
        ...
        initialContentPosition.z =
          primSize.width -
          (initialContentPosition.x + initialContentArea.width);
        initialContentPosition.w =
          primSize.height -
          (initialContentPosition.y + initialContentArea.height);
      }
    };
    Rectangle2D.prototype._getActualSizeFromContentToRef = function(
      primSize,
      paddingOffset,
      newPrimSize
    ) {
      // Fall back to default implementation if there's no round Radius
      if (this._notRounded) {
        _super.prototype._getActualSizeFromContentToRef.call(
          this,
          primSize,
          paddingOffset,
          newPrimSize
    ...
    Rectangle2D.prototype.createInstanceDataParts = function() {
      ...
      if (this.border) {
        res.push(
          new Rectangle2DInstanceData(BABYLON.Shape2D.SHAPE2D_BORDERPARTID)
        );
      }
      if (this.fill) {
        res.push(
          new Rectangle2DInstanceData(BABYLON.Shape2D.SHAPE2D_FILLPARTID)
        );
      }
      return res;
    };
    Rectangle2D.prototype.refreshInstanceDataPart = function(part) {
      ...
      if (part.id === BABYLON.Shape2D.SHAPE2D_BORDERPARTID) {
        var d = part;
        var size = this.actualSize;
        d.properties = new BABYLON.Vector3(
          size.width /* * s.x*/,
          size.height /* * s.y*/,
          this.roundRadius || 0
        );
  ...
  __decorate(
    [
      BABYLON.modelLevelProperty(
        BABYLON.Shape2D.SHAPE2D_PROPCOUNT + 2,
        function(pi) {
          return (Rectangle2D_1.notRoundedProperty = pi);
        }
      ),
    ],
  ...
  __decorate(
    [
      BABYLON.instanceLevelProperty(
        BABYLON.Shape2D.SHAPE2D_PROPCOUNT + 3,
        function(pi) {
          return (Rectangle2D_1.roundRadiusProperty = pi);
        }
      ),
    ],
    Rectangle2D.prototype,
...
(function(BABYLON) {
  ...
  __decorate(
    [BABYLON.instanceData()],
    Ellipse2DInstanceData.prototype,
    'properties',
    null
  );
  ...
  var Ellipse2D = (Ellipse2D_1 = (function(_super) {
    ...
    Ellipse2D.prototype.setupModelRenderCache = function(modelRenderCache) {
      ...
      if (this.fill) {
        ...
        if (ei) {
          renderCache.effectFillInstanced = engine.createEffect(
            { vertex: 'ellipse2d', fragment: 'ellipse2d' },
            ei.attributes,
            ei.uniforms,
            [],
            ei.defines,
    ...
    Ellipse2D.prototype.createInstanceDataParts = function() {
      ...
      if (this.border) {
        res.push(
          new Ellipse2DInstanceData(BABYLON.Shape2D.SHAPE2D_BORDERPARTID)
        );
      }
      if (this.fill) {
  ...
  __decorate(
    [
      BABYLON.modelLevelProperty(
        BABYLON.Shape2D.SHAPE2D_PROPCOUNT + 2,
        function(pi) {
          return (Ellipse2D_1.subdivisionsProperty = pi);
        }
      ),
    ],
    Ellipse2D.prototype,
...
(function(BABYLON) {
  var Sprite2DRenderCache = (function(_super) {
    ...
    Sprite2DRenderCache.prototype.render = function(instanceInfo, context) {
      ...
      effect.setBool(
        'alphaTest',
        context.renderMode === BABYLON.Render2DContext.RenderModeAlphaTest
      );
      var pid = context.groupInfoPartData[0];
      if (context.useInstancing) {
        if (!this.instancingAttributes) {
          this.instancingAttributes = this.loadInstancingAttributes(
            Sprite2D.SPRITE2D_MAINPARTID,
            effect
          );
        }
        var glBuffer = context.instancedBuffers
  ...
  var Sprite2D = (Sprite2D_1 = (function(_super) {
    ...
    function Sprite2D(texture, settings) {
      ...
      _this._spriteSize =
        settings.spriteSize != null ? settings.spriteSize.clone() : null;
      _this._spriteLocation =
        settings.spriteLocation != null
          ? settings.spriteLocation.clone()
      ...
      if (settings.spriteSize == null || !texture.isReady()) {
        if (texture.isReady()) {
          ...
          texture.onLoadObservable.add(function() {
            ...
            _this._instanceDirtyFlags |=
              BABYLON.Prim2DBase.originProperty.flagId |
              Sprite2D_1.textureProperty.flagId; // To make sure the sprite is issued again for render
          });
        }
      }
      return _this;
    ...
    Sprite2D.prototype.getAnimatables = function() {
      ...
      if (
        ...
        this.texture.animations.length > 0
      ) {
    ...
    Sprite2D.prototype.setupModelRenderCache = function(modelRenderCache) {
      ...
      // Get the instanced version of the effect, if the engine does not support it, null is return and we'll only draw on by one
      var ei = this.getDataPartEffectInfo(
        Sprite2D_1.SPRITE2D_MAINPARTID,
        ['index'],
        ['alphaTest'],
        true
      );
    ...
    Sprite2D.prototype.refreshInstanceDataPart = function(part) {
      ...
      if (part.id === Sprite2D_1.SPRITE2D_MAINPARTID) {
        ...
        if (Sprite2D_1.layoutConstructMode) {
          ...
          if (scale9 != null) {
            var normalizedScale9 = new BABYLON.Vector4(
              scale9.x * suv.x / ss.width,
              scale9.y * suv.y / ss.height,
              scale9.z * suv.x / ss.width,
              scale9.w * suv.y / ss.height
            );
    ...
    Sprite2D.prototype._mustUpdateInstance = function() {
      var res =
        this._oldTextureHasAlpha !==
        (this.texture != null && this.texture.hasAlpha);
    ...
    Sprite2D.prototype._shouldUseAlphaFromTexture = function() {
      return (
        this.texture != null &&
        this.texture.hasAlpha &&
        this.useAlphaFromTexture
      );
    };
  ...
  __decorate(
    [
      BABYLON.modelLevelProperty(
        BABYLON.RenderablePrim2D.RENDERABLEPRIM2D_PROPCOUNT + 1,
        function(pi) {
          return (Sprite2D_1.textureProperty = pi);
        }
      ),
    ],
    Sprite2D.prototype,
  ...
  __decorate(
    [
      BABYLON.dynamicLevelProperty(
        BABYLON.RenderablePrim2D.RENDERABLEPRIM2D_PROPCOUNT + 2,
        function(pi) {
          return (Sprite2D_1.useAlphaFromTextureProperty = pi);
        }
      ),
    ],
    Sprite2D.prototype,
  ...
  __decorate(
    [
      BABYLON.instanceLevelProperty(
        BABYLON.RenderablePrim2D.RENDERABLEPRIM2D_PROPCOUNT + 4,
        function(pi) {
          return (Sprite2D_1.spriteSizeProperty = pi);
        },
        false,
        true
      ),
  ...
  __decorate(
    [
      BABYLON.instanceLevelProperty(
        BABYLON.RenderablePrim2D.RENDERABLEPRIM2D_PROPCOUNT + 5,
        function(pi) {
          return (Sprite2D_1.spriteLocationProperty = pi);
        }
      ),
    ],
    Sprite2D.prototype,
  ...
  __decorate(
    [
      BABYLON.instanceLevelProperty(
        BABYLON.RenderablePrim2D.RENDERABLEPRIM2D_PROPCOUNT + 6,
        function(pi) {
          return (Sprite2D_1.spriteFrameProperty = pi);
        }
      ),
    ],
    Sprite2D.prototype,
  ...
  __decorate(
    [
      BABYLON.instanceLevelProperty(
        BABYLON.RenderablePrim2D.RENDERABLEPRIM2D_PROPCOUNT + 7,
        function(pi) {
          return (Sprite2D_1.invertYProperty = pi);
        }
      ),
    ],
    Sprite2D.prototype,
  ...
  __decorate(
    [
      BABYLON.modelLevelProperty(
        BABYLON.RenderablePrim2D.RENDERABLEPRIM2D_PROPCOUNT + 8,
        function(pi) {
          return (Sprite2D_1.spriteScale9Property = pi);
        }
      ),
    ],
    Sprite2D.prototype,
  ...
  __decorate(
    [BABYLON.instanceData()],
    Sprite2DInstanceData.prototype,
    'topLeftUV',
    null
  );
  __decorate(
...
(function(BABYLON) {
  ...
  var AtlasPictureInfo = (function() {
    ...
    /**
         ...
         */
    AtlasPictureInfo.prototype.createSprites = function(
      filterCallback,
      spriteSettings
    ) {
      var _this = this;
    ...
    /**
         ...
         */
    AtlasPictureInfo.prototype.createSprite = function(
      subPictureName,
      spriteSettings
    ) {
  ...
  var AtlasPictureInfoFactory = (function() {
    ...
    AtlasPictureInfoFactory.addLoader = function(fileExtension, plugin) {
      var a = AtlasPictureInfoFactory.plugins.getOrAddWithFactory(
        fileExtension.toLocaleLowerCase(),
        function() {
          return new Array();
        }
    ...
    /**
         ...
         */
    AtlasPictureInfoFactory.loadFromUrl = function(
      texture,
      url,
      onLoad,
      onError
      ...
      BABYLON.Tools.LoadFile(
        ...
        function(data) {
          ...
          var plugins = AtlasPictureInfoFactory.plugins.get(
            ext.toLocaleLowerCase()
          );
          if (!plugins) {
            if (onError) {
    ...
    JSONArrayLoader.prototype.loadFile = function(content) {
      ...
      try {
        ...
        for (var _i = 0, frames_2 = frames_1; _i < frames_2.length; _i++) {
          ...
          aspi.location = new BABYLON.Vector2(
            f.frame.x,
            api.atlasSize.height - (f.frame.y + f.frame.h)
          );
...
(function(BABYLON) {
  var Text2DRenderCache = (function(_super) {
    ...
    Text2DRenderCache.prototype.render = function(instanceInfo, context) {
      ...
      if (!sdf) {
        ...
        engine.setAlphaMode(
          this.fontPremulAlpha
            ? BABYLON.Engine.ALPHA_PREMULTIPLIED
  ...
  var Text2D = (Text2D_1 = (function(_super) {
    ...
    function Text2D(text, settings) {
      ...
      if (settings.bitmapFontTexture != null) {
        ...
        if (ft != null && !ft.isReady()) {
          ft.onLoadObservable.add(function() {
            ...
            _this._setLayoutDirty();
            _this._instanceDirtyFlags |=
              BABYLON.Prim2DBase.originProperty.flagId; // To make sure the Text2D is issued again for render
          });
        }
      } else {
        _this._fontName =
          settings.fontName == null ? '12pt Arial' : settings.fontName;
        _this._fontSuperSample =
          settings.fontSuperSample != null && settings.fontSuperSample;
        _this._fontSDF =
          settings.fontSignedDistanceField != null &&
          settings.fontSignedDistanceField;
      }
      _this._defaultFontColor =
        settings.defaultFontColor == null
          ? new BABYLON.Color4(1, 1, 1, 1)
          : settings.defaultFontColor.clone();
      _this._tabulationSize =
      ...
      _this._useBilinearFiltering =
        settings.useBilinearFiltering != null
          ? settings.useBilinearFiltering
          : null;
      _this._fontBilinearFiltering = false;
      // Text rendering must always be aligned to the target's pixel to ensure a good quality
      _this.alignToPixel = true;
      _this.textAlignmentH =
        settings.textAlignmentH == null
          ? Text2D_1.AlignLeft
          : settings.textAlignmentH;
      _this.textAlignmentV =
        settings.textAlignmentV == null
          ? Text2D_1.AlignTop
          : settings.textAlignmentV;
      _this.textAlignment =
        settings.textAlignment == null ? '' : settings.textAlignment;
    ...
    Object.defineProperty(Text2D.prototype, 'fontTexture', {
      get: function() {
        ...
        if (
          this.fontName == null ||
          this.owner == null ||
          this.owner.scene == null
        ) {
          return null;
        }
        this._fontBilinearFiltering =
          this._useBilinearFiltering === null
            ? this.owner instanceof BABYLON.WorldSpaceCanvas2D
            : this._useBilinearFiltering;
        this._fontTexture = BABYLON.FontTexture.GetCachedFontTexture(
          this.owner.scene,
          this.fontName,
          this._fontSuperSample,
          this._fontSDF,
          this._fontBilinearFiltering
        );
    ...
    Text2D.prototype.dispose = function() {
      ...
      if (this._fontTexture) {
        BABYLON.FontTexture.ReleaseCachedFontTexture(
          this.owner.scene,
          this.fontName,
          this._fontSuperSample,
          this._fontSDF,
    ...
    Text2D.prototype.createInstanceDataParts = function() {
      return [
        new Text2DInstanceData(Text2D_1.TEXT2D_MAINPARTID, this._charCount),
      ];
    };
    ...
    Text2D.prototype.refreshInstanceDataPart = function(part) {
      ...
      if (part.id === Text2D_1.TEXT2D_MAINPARTID) {
        ...
        if (alignH == Text2D_1.AlignRight) {
          ...
          offsetX += (contentAreaWidth - maxLineLen) * 0.5;
        }
        ...
        if (alignV == Text2D_1.AlignBottom) {
          ...
          offset.y -=
            (contentAreaHeight - textHeight) * 0.5 + lineLengths.length * lh;
        } else {
        ...
        for (var i_3 = 0; i_3 < lineLengths.length; i_3++) {
          ...
          if (alignH == Text2D_1.AlignRight) {
            ...
            offset.x += (maxLineLen - lineLength) * 0.5;
          }
          for (var j = 0; j < numChars; j++) {
            ...
            if (char !== '\t' && !this._isWhiteSpaceCharVert(char)) {
              ...
              var ci = texture.getChar(char);
              var partOffset = new BABYLON.Vector2(
                Math.floor(offset.x + ci.xOffset),
                Math.floor(offset.y + ci.yOffset)
              );
  ...
  __decorate(
    [
      BABYLON.modelLevelProperty(
        BABYLON.RenderablePrim2D.RENDERABLEPRIM2D_PROPCOUNT + 1,
        function(pi) {
          return (Text2D_1.fontProperty = pi);
        },
        false,
        true
      ),
  ...
  __decorate(
    [
      BABYLON.dynamicLevelProperty(
        BABYLON.RenderablePrim2D.RENDERABLEPRIM2D_PROPCOUNT + 2,
        function(pi) {
          return (Text2D_1.defaultFontColorProperty = pi);
        }
      ),
    ],
    Text2D.prototype,
  ...
  __decorate(
    [
      BABYLON.instanceLevelProperty(
        BABYLON.RenderablePrim2D.RENDERABLEPRIM2D_PROPCOUNT + 3,
        function(pi) {
          return (Text2D_1.textProperty = pi);
        },
        false,
        true
      ),
  ...
  __decorate(
    [
      BABYLON.instanceLevelProperty(
        BABYLON.RenderablePrim2D.RENDERABLEPRIM2D_PROPCOUNT + 4,
        function(pi) {
          return (Text2D_1.sizeProperty = pi);
        }
      ),
    ],
    Text2D.prototype,
  ...
  __decorate(
    [
      BABYLON.modelLevelProperty(
        BABYLON.RenderablePrim2D.RENDERABLEPRIM2D_PROPCOUNT + 5,
        function(pi) {
          return (Text2D_1.fontSuperSampleProperty = pi);
        },
        false,
        false
      ),
  ...
  __decorate(
    [
      BABYLON.modelLevelProperty(
        BABYLON.RenderablePrim2D.RENDERABLEPRIM2D_PROPCOUNT + 6,
        function(pi) {
          return (Text2D_1.fontSignedDistanceFieldProperty = pi);
        },
        false,
        false
      ),
  ...
  __decorate(
    [
      BABYLON.instanceLevelProperty(
        BABYLON.RenderablePrim2D.RENDERABLEPRIM2D_PROPCOUNT + 7,
        function(pi) {
          return (Text2D_1.textureIsPremulAlphaProperty = pi);
        }
      ),
    ],
    Text2D.prototype,
    'textureIsPremulAlpha',
    null
  );
  __decorate(
    [
      BABYLON.modelLevelProperty(
        BABYLON.RenderablePrim2D.RENDERABLEPRIM2D_PROPCOUNT + 8,
        function(pi) {
          return (Text2D_1.fontTextureProperty = pi);
        }
      ),
    ],
    Text2D.prototype,
...
(function(BABYLON) {
  ...
  var Lines2D = (Lines2D_1 = (function(_super) {
    ...
    Object.defineProperty(Lines2D, 'SquareAnchorCap', {
      /**
             ...
             */
      get: function() {
        return Lines2D_1._squareAnchorCap;
      },
      enumerable: true,
      configurable: true,
    });
    Object.defineProperty(Lines2D, 'RoundAnchorCap', {
      /**
             ...
             */
      get: function() {
        return Lines2D_1._roundAnchorCap;
      },
      enumerable: true,
      configurable: true,
    });
    Object.defineProperty(Lines2D, 'DiamondAnchorCap', {
      /**
             ...
             */
      get: function() {
        return Lines2D_1._diamondAnchorCap;
      },
      enumerable: true,
      configurable: true,
    });
    ...
    Lines2D.prototype._intersect = function(x1, y1, x2, y2, x3, y3, x4, y4) {
      ...
      if (d === 0) return false;
      var xi =
        ((x3 - x4) * (x1 * y2 - y1 * x2) - (x1 - x2) * (x3 * y4 - y3 * x4)) / d; // Intersection point is xi/yi, just in case...
    ...
    Lines2D.prototype._store = function(
      array,
      contour,
      index,
      max,
    ...
    Lines2D.prototype._storeVertex = function(
      vb,
      baseOffset,
      index,
      basePos,
    ...
    Lines2D.prototype._storeIndex = function(
      ib,
      baseOffset,
      index,
      vertexIndex
    ...
    Lines2D.prototype._buildCap = function(
      vb,
      vbi,
      ib,
      ibi,
      ...
      switch (type) {
        case Lines2D_1.NoCap:
          if (borderMode && !this.closed) {
            var vi = 0;
            var ii = 0;
            var v1 = this._storeVertex(
              vb,
              vbi,
              vi++,
              pos,
              angle,
              new BABYLON.Vector2(0, ht + bt),
              contour
            );
            var v2 = this._storeVertex(
              vb,
              vbi,
              vi++,
              pos,
              angle,
              new BABYLON.Vector2(bt, ht + bt),
              contour
            );
            var v3 = this._storeVertex(
              vb,
              vbi,
              vi++,
              pos,
        ...
        case Lines2D_1.TriangleCap: {
          if (borderMode) {
            var f =
              type === Lines2D_1.TriangleCap ? bt : Math.sqrt(bt * bt * 2);
            var v1 = this._storeVertex(
              vb,
              vbi,
              0,
            ...
            var v4 = this._storeVertex(
              ...
              pos,
              angle,
              new BABYLON.Vector2(0, ht + f),
              contour
            );
            var v5 = this._storeVertex(
              vb,
              vbi,
              4,
              pos,
              angle,
              new BABYLON.Vector2(ht + f, 0),
              contour
            );
            var v6 = this._storeVertex(
              vb,
              vbi,
              5,
              pos,
            ...
            if (type === Lines2D_1.ArrowCap) {
              var rht = thickness / 2;
              var v10 = this._storeVertex(
                vb,
                vbi,
                9,
                pos,
                angle,
                new BABYLON.Vector2(0, -(rht + bt)),
                null
              );
              var v12 = this._storeVertex(
                vb,
                vbi,
                11,
                pos,
                angle,
                new BABYLON.Vector2(-bt, -(ht + f)),
                contour
              );
              var v11 = this._storeVertex(
                vb,
                vbi,
                10,
                pos,
                angle,
                new BABYLON.Vector2(-bt, -(rht + bt)),
                contour
              );
              var v7 = this._storeVertex(
                vb,
                vbi,
                6,
                pos,
          ...
          if (borderMode) {
            ...
            for (var i = 0; i < sd / 2; i++) {
              var v1 = this._storeVertex(
                ...
                pos,
                angle,
                new BABYLON.Vector2(Math.cos(curA) * ht, Math.sin(curA) * ht),
                null
              );
              var v2 = this._storeVertex(
                vb,
        ...
        case Lines2D_1.SquareAnchorCap: {
          ...
          if (borderMode) {
            ...
            var v8 = this._storeVertex(
              ...
              pos,
              angle,
              new BABYLON.Vector2(t * 2 + bt, t + bt),
              contour
            );
            var v9 = this._storeVertex(
              vb,
    ...
    Lines2D.prototype.setupModelRenderCache = function(modelRenderCache) {
      ...
      if (this.border) {
        ...
        if (ei) {
          renderCache.effectBorderInstanced = engine.createEffect(
            { vertex: 'lines2d', fragment: 'lines2d' },
            ei.attributes,
            ei.uniforms,
            [],
            ei.defines,
    ...
    Lines2D.prototype._computeLines2D = function() {
      ...
      this._boundingMin = new BABYLON.Vector2(
        Number.MAX_VALUE,
        Number.MAX_VALUE
      );
      this._boundingMax = new BABYLON.Vector2(
        Number.MIN_VALUE,
        Number.MIN_VALUE
      );
      ...
      if (this.fill) {
        ...
        this._fillIB = new Float32Array(
          triCount * 3 + startCapInfo.ibsize + endCapInfo.ibsize
        );
        var ib = this._fillIB;
        ...
        this._buildCap(
          ...
          this.startCap,
          Lines2D_1._startDir,
          this.border ? null : startCapContour
        );
        this._buildCap(
          vb,
          count * 2 * 2 + startCapInfo.vbsize,
          ib,
          triCount * 3 + startCapInfo.ibsize,
          this.points[total - 1],
          this.fillThickness,
          null,
          this.endCap,
      ...
      if (this.border) {
        ...
        var count = this.points.length;
        var vbSize =
          count * 2 * 2 * 2 + startCapInfo.vbsize + endCapInfo.vbsize;
        ...
        this._borderIB = new Float32Array(
          triCount * 3 + startCapInfo.ibsize + endCapInfo.ibsize
        );
        ...
        this._buildCap(
          vb,
          count * 2 * 2 * 2 + startCapInfo.vbsize,
          ib,
          triCount * 3 + startCapInfo.ibsize,
          this.points[total - 1],
          this.fillThickness,
      ...
      // Build the Tri2DArray using the contour info from the shape and the caps (if any)
      {
        ...
        var count =
          (this.closed ? pl : pl - 1) * 2 +
          (startCapTri != null
            ? (startCapTri.length + endCapTri.length) / 3
            : 0);
  ...
  __decorate(
    [
      BABYLON.modelLevelProperty(
        BABYLON.Shape2D.SHAPE2D_PROPCOUNT + 1,
        function(pi) {
          return (Lines2D_1.pointsProperty = pi);
        }
      ),
    ],
    Lines2D.prototype,
  ...
  __decorate(
    [
      BABYLON.modelLevelProperty(
        BABYLON.Shape2D.SHAPE2D_PROPCOUNT + 2,
        function(pi) {
          return (Lines2D_1.fillThicknessProperty = pi);
        }
      ),
    ],
    Lines2D.prototype,
  ...
  __decorate(
    [
      BABYLON.modelLevelProperty(
        BABYLON.Shape2D.SHAPE2D_PROPCOUNT + 3,
        function(pi) {
          return (Lines2D_1.closedProperty = pi);
        }
      ),
    ],
    Lines2D.prototype,
  ...
  __decorate(
    [
      BABYLON.modelLevelProperty(
        BABYLON.Shape2D.SHAPE2D_PROPCOUNT + 4,
        function(pi) {
          return (Lines2D_1.startCapProperty = pi);
        }
      ),
    ],
    Lines2D.prototype,
  ...
  __decorate(
    [
      BABYLON.modelLevelProperty(
        BABYLON.Shape2D.SHAPE2D_PROPCOUNT + 5,
        function(pi) {
          return (Lines2D_1.endCapProperty = pi);
        }
      ),
    ],
    Lines2D.prototype,
...
(function(BABYLON) {
  ...
  var Canvas2DEngineBoundData = (function() {
    ...
    Canvas2DEngineBoundData.prototype.GetOrAddModelCache = function(
      key,
      factory
    ) {
      return this._modelCache.getOrAddWithFactory(key, factory);
    };
    Canvas2DEngineBoundData.prototype.DisposeModelRenderCache = function(
      modelRenderCache
    ) {
  ...
  var Canvas2D = (Canvas2D_1 = (function(_super) {
    ...
    function Canvas2D(scene, settings) {
      ...
      if (_this._cachingStrategy !== Canvas2D_1.CACHESTRATEGY_TOPLEVELGROUPS) {
        _this._background = new BABYLON.Rectangle2D({
          parent: _this,
        ...
        if (settings.backgroundBorder != null) {
          if (typeof settings.backgroundBorder === 'string') {
            _this.backgroundBorder = Canvas2D_1.GetBrushFromString(
              settings.backgroundBorder
            );
          } else {
        ...
        if (settings.backgroundFill != null) {
          if (typeof settings.backgroundFill === 'string') {
            _this.backgroundFill = Canvas2D_1.GetBrushFromString(
      ...
      _this.__engineData = engine.getOrAddExternalDataWithFactory(
        '__BJSCANVAS2D__',
        function(k) {
      ...
      var enableInteraction =
        settings.enableInteraction == null ? true : settings.enableInteraction;
      _this._fitRenderingDevice = !settings.size;
      if (!settings.size) {
        settings.size = new BABYLON.Size(
      ...
      if (_this._isScreenSpace) {
        if (settings.renderingPhase) {
          if (
            !settings.renderingPhase.camera ||
            settings.renderingPhase.renderingGroupID == null
          ) {
            throw Error(
              'You have to specify a valid camera and renderingGroup'
            );
          }
          _this._renderingGroupObserver = _this._scene.onRenderingGroupObservable.add(
            function(e, s) {
              if (
                _this._scene.activeCamera === settings.renderingPhase.camera &&
                e.renderStage ===
                  BABYLON.RenderingGroupInfo.STAGE_POSTTRANSPARENT
              ) {
          ...
          _this._afterRenderObserver = _this._scene.onAfterRenderObservable.add(
            function(d, s) {
              _this._engine.clear(null, false, true, true);
              BABYLON.C2DLogging._startFrameRender();
              _this._render();
        ...
        _this._beforeRenderObserver = _this._scene.onBeforeRenderObservable.add(
          function(d, s) {
            BABYLON.C2DLogging._startFrameRender();
            _this._render();
            BABYLON.C2DLogging._endFrameRender();
      ...
      _this._supprtInstancedArray =
        _this._engine.getCaps().instancedArrays !== null;
      ...
      if (settings.enableCollisionManager) {
        ...
        _this._primitiveCollisionManager =
          settings.customCollisionManager == null
            ? BABYLON.PrimitiveCollisionManagerBase.allocBasicPCM(
                _this,
                enableBorders
              )
            : settings.customCollisionManager(_this, enableBorders);
      }
    ...
    Object.defineProperty(
      Canvas2D.prototype,
      'layoutBoundingInfoUpdateCounter',
      {
        get: function() {
    ...
    Canvas2D.prototype._canvasPreInit = function(settings) {
      var cachingStrategy =
        settings.cachingStrategy == null
          ? Canvas2D_1.CACHESTRATEGY_DONTCACHE
          : settings.cachingStrategy;
      this._cachingStrategy = cachingStrategy;
      this._isScreenSpace =
        settings.isScreenSpace == null ? true : settings.isScreenSpace;
      ...
      if (this._isScreenSpace) {
        ...
        if (!enable) {
          if (this._scenePrePointerObserver) {
            this.scene.onPrePointerObservable.remove(
              this._scenePrePointerObserver
            );
        ...
        this._scenePrePointerObserver = this.scene.onPrePointerObservable.add(
          function(e, s) {
        ...
        if (enable) {
          ...
          this._scenePointerObserver = scene.onPointerObservable.add(function(
            e,
            s
          ) {
            if (_this.isVisible === false) {
            ...
            if (
              e.pickInfo.hit &&
              e.pickInfo.pickedMesh === _this._worldSpaceNode &&
              _this.worldSpaceToNodeLocal
            ) {
              var localPos = _this.worldSpaceToNodeLocal(
                e.pickInfo.pickedPoint
              );
              _this._handlePointerEventForInteraction(e, localPos, s);
            } else if (
              _this._actualIntersectionList &&
              _this._actualIntersectionList.length > 0
            ) {
    ...
    Canvas2D.prototype._setPointerCapture = function(pointerId, primitive) {
      ...
      this._primPointerInfo.updateRelatedTarget(
        primitive,
        BABYLON.Vector2.Zero()
      );
      this._bubbleNotifyPrimPointerObserver(
        primitive,
    ...
    Canvas2D.prototype._releasePointerCapture = function(pointerId, primitive) {
      ...
      this._bubbleNotifyPrimPointerObserver(
        primitive,
        BABYLON.PrimitivePointerInfo.PointerLostCapture,
        null
      );
    ...
    Canvas2D.prototype._handlePointerEventForInteraction = function(
      eventData,
      localPosition,
      eventState
    ) {
      ...
      var capturedPrim = this.getCapturedPrimitive(
        this._primPointerInfo.pointerId
      );
      ...
      this._updateIntersectionList(
        localPosition ? this._primPointerInfo.canvasPointerPos : null,
        capturedPrim !== null,
        true
      );
      ...
      var targetPointerPos = capturedPrim
        ? this._primPointerInfo.canvasPointerPos.subtract(
            new BABYLON.Vector2(
              targetPrim.globalTransform.m[4],
              targetPrim.globalTransform.m[5]
            )
          )
        : this._actualOverPrimitive.intersectionLocation;
      ...
      if (eventData.type === BABYLON.PointerEventTypes.POINTERWHEEL) {
        skip = !this._bubbleNotifyPrimPointerObserver(
          targetPrim,
    ...
    Canvas2D.prototype._updatePointerInfo = function(eventData, localPosition) {
      ...
      var camera =
        this._scene.cameraToUseForPointers || this._scene.activeCamera;
      ...
      if (this._isScreenSpace) {
        ...
        pii.canvasPointerPos.y =
          (renderHeight - y - this.actualPosition.y) / s.y;
      } else {
      ...
      if (eventData.type === BABYLON.PointerEventTypes.POINTERWHEEL) {
        ...
        if (event.wheelDelta) {
          pii.mouseWheelDelta =
            event.wheelDelta /
            (BABYLON.PrimitivePointerInfo.MouseWheelPrecision * 40);
        } else if (event.detail) {
          pii.mouseWheelDelta =
            -event.detail / BABYLON.PrimitivePointerInfo.MouseWheelPrecision;
        }
      } else {
    ...
    Canvas2D.prototype._updateIntersectionList = function(
      mouseLocalPos,
      isCapture,
      force
    ) {
      ...
      if (!outCase) {
        ...
        if (
          !isCapture &&
          !this.levelBoundingInfo.doesIntersect(ii.pickPosition)
        ) {
          ...
          ii.intersectedPrimitives = ii.intersectedPrimitives.sort(function(
            a,
            b
          ) {
            return a.prim.actualZOffset - b.prim.actualZOffset;
          });
        }
      }
      {
        ...
        this._actualIntersectionList = outCase
          ? new Array()
          : ii.intersectedPrimitives;
        this._previousOverPrimitive = this._actualOverPrimitive;
        this._actualOverPrimitive = outCase
          ? null
          : ii.topMostIntersectedPrimitive;
        var prev =
          this._previousOverPrimitive != null
            ? this._previousOverPrimitive.prim
            : null;
        var actual =
          this._actualOverPrimitive != null
            ? this._actualOverPrimitive.prim
            : null;
        if (prev !== actual) {
          this.onPropertyChanged(
            'overPrim',
            this._previousOverPrimitive
              ? this._previousOverPrimitive.prim
              : null,
            this._actualOverPrimitive ? this._actualOverPrimitive.prim : null
          );
        }
      }
    ...
    Canvas2D.prototype._updateOverStatus = function(force) {
      if (
        (!force && this.scene.getRenderId() === this._hoverStatusRenderId) ||
        !this._actualIntersectionList
      ) {
        return;
      }
      ...
      var prevPrim = this._previousOverPrimitive
        ? this._previousOverPrimitive.prim
        : null;
      var actualPrim = this._actualOverPrimitive
        ? this._actualOverPrimitive.prim
        : null;
      if (prevPrim !== actualPrim) {
        ...
        if (capturedPrim) {
          if (capturedPrim === prevPrim) {
            this._primPointerInfo.updateRelatedTarget(
              prevPrim,
              this._previousOverPrimitive.intersectionLocation
            );
            this._bubbleNotifyPrimPointerObserver(
              prevPrim,
          ...
          var _loop_1 = function(prev) {
            if (
              !BABYLON.Tools.first(this_1._actualIntersectionList, function(
                pii
              ) {
                return pii.prim === prev.prim;
              })
            ) {
              this_1._primPointerInfo.updateRelatedTarget(
                prev.prim,
                prev.intersectionLocation
              );
              this_1._bubbleNotifyPrimPointerObserver(
                prev.prim,
                BABYLON.PrimitivePointerInfo.PointerOut,
                null
              );
          ...
          // Check for Out & Leave
          for (
            var _i = 0, _a = this._previousIntersectionList;
            _i < _a.length;
            _i++
          ) {
            var prev = _a[_i];
          ...
          var _loop_2 = function(actual) {
            if (
              !BABYLON.Tools.first(this_2._previousIntersectionList, function(
                pii
              ) {
                return pii.prim === actual.prim;
              })
            ) {
              this_2._primPointerInfo.updateRelatedTarget(
                actual.prim,
                actual.intersectionLocation
              );
              this_2._bubbleNotifyPrimPointerObserver(
                actual.prim,
                BABYLON.PrimitivePointerInfo.PointerOver,
                null
              );
          ...
          for (
            var _b = 0, _c = this._actualIntersectionList;
            _b < _c.length;
            _b++
          ) {
            var actual = _c[_b];
    ...
    Canvas2D.prototype._updatePrimPointerPos = function(prim) {
      if (this._primPointerInfo.isCaptured) {
        ...
        for (
          var _i = 0, _a = this._actualIntersectionList;
          _i < _a.length;
          _i++
        ) {
          var pii = _a[_i];
          if (pii.prim === prim) {
            this._primPointerInfo.primitivePointerPos =
              pii.intersectionLocation;
            return;
          }
        }
      }
    ...
    Canvas2D.prototype._debugExecObserver = function(prim, mask) {
      ...
      debug +=
        '[RID:' +
        this.scene.getRenderId() +
        '] [' +
        prim.hierarchyDepth +
        '] event:' +
        BABYLON.PrimitivePointerInfo.getEventTypeName(mask) +
        ', id: ' +
        prim.id +
        ' (' +
        BABYLON.Tools.getClassName(prim) +
        '), primPos: ' +
        pii.primitivePointerPos.toString() +
        ', canvasPos: ' +
        pii.canvasPointerPos.toString() +
        ', relatedTarget: ' +
        pii.relatedTarget.id;
      console.log(debug);
    };
    Canvas2D.prototype._bubbleNotifyPrimPointerObserver = function(
      prim,
      mask,
      eventData
    ) {
      ...
      while (cur && !cur.isDisposed) {
        ...
        if (cur === prim) {
          ...
          if (mask === BABYLON.PrimitivePointerInfo.PointerOver) {
            this._debugExecObserver(
              prim,
              BABYLON.PrimitivePointerInfo.PointerEnter
            );
            prim._pointerEventObservable.notifyObservers(
              ppi,
              BABYLON.PrimitivePointerInfo.PointerEnter
            );
        ...
        if (
          ...
          eventData instanceof BABYLON.PointerInfoPre
        ) {
    ...
    Canvas2D.prototype._triggerActionManager = function(
      prim,
      ppi,
      mask,
      eventData
      ...
      if ((mask & BABYLON.PrimitivePointerInfo.PointerDown) !== 0) {
        ...
        if (prim.actionManager) {
          ...
          if (prim.actionManager.hasPickTriggers) {
            var actionEvent = BABYLON.ActionEvent.CreateNewFromPrimitive(
              prim,
              ppi.primitivePointerPos,
              eventData
            );
            switch (eventData.button) {
              case 0:
                prim.actionManager.processTrigger(
          ...
          if (
            prim.actionManager.hasSpecificTrigger(
            ...
            window.setTimeout(function() {
              ...
              _this._updateIntersectionList(
                ppi.canvasPointerPos,
                capturedPrim !== null,
                true
              );
              ...
              if (ii.isPrimIntersected(prim) !== null) {
                if (prim.actionManager) {
                  if (
                    ...
                    new Date().getTime() - _this._pickStartingTime >
                      BABYLON.Scene.LongPressDelay &&
                    (Math.abs(
                      _this._pickStartingPosition.x - ii.pickPosition.x
                    ) < BABYLON.Scene.DragMovementThreshold &&
                      Math.abs(
                        _this._pickStartingPosition.y - ii.pickPosition.y
                      ) < BABYLON.Scene.DragMovementThreshold)
                  ) {
                    _this._pickStartingTime = 0;
                    prim.actionManager.processTrigger(
                      BABYLON.ActionManager.OnLongPressTrigger,
                      BABYLON.ActionEvent.CreateNewFromPrimitive(
                        prim,
                        ppi.primitivePointerPos,
                        eventData
                      )
        ...
        if (prim.actionManager) {
          ...
          // OnPickTrigger
          if (
            Math.abs(this._pickStartingPosition.x - ppi.canvasPointerPos.x) <
              BABYLON.Scene.DragMovementThreshold &&
            Math.abs(this._pickStartingPosition.y - ppi.canvasPointerPos.y) <
              BABYLON.Scene.DragMovementThreshold
          ) {
            prim.actionManager.processTrigger(
        ...
        // OnPickOutTrigger
        if (
          this._pickedDownPrim &&
          this._pickedDownPrim.actionManager &&
          this._pickedDownPrim !== prim
        ) {
          this._pickedDownPrim.actionManager.processTrigger(
    ...
    Canvas2D.prototype.dispose = function() {
      ...
      if (this._renderingGroupObserver) {
        this._scene.onRenderingGroupObservable.remove(
          this._renderingGroupObserver
        );
    ...
    Object.defineProperty(Canvas2D.prototype, 'overPrim', {
      ...
      get: function() {
        if (
          this._actualIntersectionList &&
          this._actualIntersectionList.length > 0
        ) {
    ...
    Canvas2D.prototype.createCanvasProfileInfoCanvas = function() {
      ...
      var canvas = new ScreenSpaceCanvas2D(this.scene, {
        ...
        cachingStrategy: Canvas2D_1.CACHESTRATEGY_DONTCACHE,
        children: [
          new BABYLON.Rectangle2D({
            id: 'ProfileBorder',
            border: '#FFFFFFFF',
    ...
    Canvas2D.prototype.checkBackgroundAvailability = function() {
      if (this._cachingStrategy === Canvas2D_1.CACHESTRATEGY_TOPLEVELGROUPS) {
        throw Error(
          "Can't use Canvas Background with the caching strategy TOPLEVELGROUPS"
        );
      }
    };
    ...
    Canvas2D.prototype._updateProfileCanvas = function() {
      ...
      var p =
        'Render Time: avg:' +
        format(this.canvasRenderTimeCounter.lastSecAverage) +
        'ms ' +
        format(this.canvasRenderTimeCounter.current) +
        'ms\n' +
        'Draw Calls:\n' +
        (' - Opaque:      ' +
          format(this.drawCallsOpaqueCounter.current) +
          ', (avg:' +
          format(this.drawCallsOpaqueCounter.lastSecAverage) +
          ', t:' +
          format(this.drawCallsOpaqueCounter.total) +
          ')\n') +
        (' - AlphaTest:   ' +
          format(this.drawCallsAlphaTestCounter.current) +
          ', (avg:' +
          format(this.drawCallsAlphaTestCounter.lastSecAverage) +
          ', t:' +
          format(this.drawCallsAlphaTestCounter.total) +
          ')\n') +
        (' - Transparent: ' +
          format(this.drawCallsTransparentCounter.current) +
          ', (avg:' +
          format(this.drawCallsTransparentCounter.lastSecAverage) +
          ', t:' +
          format(this.drawCallsTransparentCounter.total) +
          ')\n') +
        ('Group Render: ' +
          this.groupRenderCounter.current +
          ', (avg:' +
          format(this.groupRenderCounter.lastSecAverage) +
          ', t:' +
          format(this.groupRenderCounter.total) +
          ')\n') +
        ('Update Transparent Data: ' +
          this.updateTransparentDataCounter.current +
          ', (avg:' +
          format(this.updateTransparentDataCounter.lastSecAverage) +
          ', t:' +
          format(this.updateTransparentDataCounter.total) +
          ')\n') +
        ('Update Cached States: ' +
          this.updateCachedStateCounter.current +
          ', (avg:' +
          format(this.updateCachedStateCounter.lastSecAverage) +
          ', t:' +
          format(this.updateCachedStateCounter.total) +
          ')\n') +
        (' - Update Layout: ' +
          this.updateLayoutCounter.current +
          ', (avg:' +
          format(this.updateLayoutCounter.lastSecAverage) +
          ', t:' +
          format(this.updateLayoutCounter.total) +
          ')\n') +
        (' - Update Positioning: ' +
          this.updatePositioningCounter.current +
          ', (avg:' +
          format(this.updatePositioningCounter.lastSecAverage) +
          ', t:' +
          format(this.updatePositioningCounter.total) +
          ')\n') +
        (' - Update Local  Trans: ' +
          this.updateLocalTransformCounter.current +
          ', (avg:' +
          format(this.updateLocalTransformCounter.lastSecAverage) +
          ', t:' +
          format(this.updateLocalTransformCounter.total) +
          ')\n') +
        (' - Update Global Trans: ' +
          this.updateGlobalTransformCounter.current +
          ', (avg:' +
          format(this.updateGlobalTransformCounter.lastSecAverage) +
          ', t:' +
          format(this.updateGlobalTransformCounter.total) +
          ')\n') +
        (' - BoundingInfo Recompute: ' +
          this.boundingInfoRecomputeCounter.current +
          ', (avg:' +
          format(this.boundingInfoRecomputeCounter.lastSecAverage) +
          ', t:' +
          format(this.boundingInfoRecomputeCounter.total) +
          ')\n') +
        (' - LayoutBoundingInfo Recompute: ' +
          this.layoutBoundingInfoUpdateCounter.current +
          ', (avg:' +
          format(this.layoutBoundingInfoUpdateCounter.lastSecAverage) +
          ', t:' +
          format(this.layoutBoundingInfoUpdateCounter.total) +
          ')');
    ...
    Canvas2D.prototype._updateTrackedNodes = function() {
      ...
      cam
        .getViewMatrix()
        .multiplyToRef(cam.getProjectionMatrix(), Canvas2D_1._m);
      ...
      for (var _i = 0, _a = this._trackedGroups; _i < _a.length; _i++) {
        ...
        var proj = BABYLON.Vector3.Project(
          Canvas2D_1._v,
          worldMtx,
          Canvas2D_1._m,
          v
      ...
      if (this._trackNode) {
        ...
        var mtx = BABYLON.Matrix.Compose(
          Canvas2D_1.tS,
          Canvas2D_1.tR,
        ...
        pos = worldmtx
          .getTranslation()
          .add(
            BABYLON.Vector3.TransformCoordinates(this._trackNodeOffset, mtx)
          );
        ...
        if (wsn instanceof BABYLON.AbstractMesh) {
          ...
          throw new Error(
            "Can't Track another Scene Node Type than AbstractMesh right now, call me lazy!"
          );
        }
      }
    };
    ...
    Canvas2D.prototype._updateAdaptiveSizeWorldCanvas = function() {
      ...
      cam
        .getViewMatrix()
        .multiplyToRef(cam.getProjectionMatrix(), Canvas2D_1._m);
      var vp = cam.viewport.toGlobal(
        this.engine.getRenderWidth(),
        this.engine.getRenderHeight()
      );
      var projPoints = new Array(4);
      for (var i = 0; i < 4; i++) {
        projPoints[i] = BABYLON.Vector3.Project(
          v[i],
          Canvas2D_1._mI,
          Canvas2D_1._m,
          vp
    ...
    Canvas2D.prototype._updateCanvasState = function(forceRecompute) {
      ...
      if (
        !forceRecompute &&
        this.scene.getRenderId() === this._updateRenderId
      ) {
        return;
      }
    ...
    Canvas2D.prototype._render = function() {
      ...
      if (this._renderObservable && this._renderObservable.hasObservers()) {
        this._renderObservable.notifyObservers(
          this,
          Canvas2D_1.RENDEROBSERVABLE_PRE
        );
      }
      ...
      if (this._primPointerInfo.canvasPointerPos) {
        this._updateIntersectionList(
          this._primPointerInfo.canvasPointerPos,
          false,
          false
        );
      ...
      if (
        this._cachingStrategy === Canvas2D_1.CACHESTRATEGY_CANVAS &&
        this._cachedCanvasGroup
      ) {
      ...
      if (this._renderObservable && this._renderObservable.hasObservers()) {
        this._renderObservable.notifyObservers(
          this,
          Canvas2D_1.RENDEROBSERVABLE_POST
        );
      }
    };
    /**
         ...
         */
    Canvas2D.prototype._allocateGroupCache = function(
      group,
      parent,
      minSize,
      useMipMap,
      ...
      if (noResizeScale) {
        scale = isCanvas
          ? Canvas2D_1._unS
          : group.parent.actualScale.multiply(this._canvasLevelScale);
      } else {
        scale = group.actualScale.multiply(this._canvasLevelScale);
      }
      // Determine size
      var size = group.actualSize;
      var scaledSize = new BABYLON.Size(
        size.width * scale.x,
        size.height * scale.y
      );
      var roundedScaledSize = new BABYLON.Size(
        Math.ceil(scaledSize.width),
        Math.ceil(scaledSize.height)
      );
      var originalSize = scaledSize.clone();
      if (minSize) {
        roundedScaledSize.width = Math.max(
          minSize.width,
          roundedScaledSize.width
        );
        roundedScaledSize.height = Math.max(
          minSize.height,
          roundedScaledSize.height
        );
      }
      ...
      if (!res) {
        var mapSize = new BABYLON.Size(
          Canvas2D_1._groupTextureCacheSize,
          Canvas2D_1._groupTextureCacheSize
        );
        // Check if the predefined size would fit, other create a custom size using the nearest bigger power of 2
        if (
          roundedScaledSize.width > mapSize.width ||
          roundedScaledSize.height > mapSize.height
        ) {
          mapSize.width = Math.pow(
            2,
            Math.ceil(Math.log(roundedScaledSize.width) / Math.log(2))
          );
          mapSize.height = Math.pow(
            2,
            Math.ceil(Math.log(roundedScaledSize.height) / Math.log(2))
          );
        }
        var id = 'groupsMapChache' + this._mapCounter++ + 'forCanvas' + this.id;
        map = new BABYLON.MapTexture(
          id,
          this._scene,
          mapSize,
          useMipMap
      ...
      if (group !== this || this._isScreenSpace) {
        ...
        if (this._cachingStrategy === Canvas2D_1.CACHESTRATEGY_CANVAS) {
          ...
          this._cachedCanvasGroup = BABYLON.Group2D._createCachedCanvasGroup(
            this
          );
        ...
        if (sprite && noResizeScale) {
          var relScale = isCanvas
            ? group.actualScale
            : group.actualScale.divide(group.parent.actualScale);
    ...
    Canvas2D.GetSolidColorBrush = function(color) {
      return Canvas2D_1._solidColorBrushes.getOrAddWithFactory(
        color.toHexString(),
        function() {
    ...
    Canvas2D.GetSolidColorBrushFromHex = function(hexValue) {
      return Canvas2D_1._solidColorBrushes.getOrAddWithFactory(
        hexValue,
        function() {
          return new BABYLON.SolidColorBrush2D(
            BABYLON.Color4.FromHexString(hexValue),
            true
          );
        }
      );
    ...
    /**
         ...
         */
    Canvas2D.GetGradientColorBrush = function(
      color1,
      color2,
      translation,
      rotation,
      ...
      return Canvas2D_1._gradientColorBrushes.getOrAddWithFactory(
        BABYLON.GradientColorBrush2D.BuildKey(
          color1,
          color2,
          translation,
          rotation,
        ...
        function() {
          return new BABYLON.GradientColorBrush2D(
            color1,
            color2,
            translation,
            rotation,
  ...
  var WorldSpaceCanvas2D = (function(_super) {
    ...
    function WorldSpaceCanvas2D(scene, size, settings) {
      ...
      settings.cachingStrategy =
        settings.cachingStrategy == null
          ? Canvas2D.CACHESTRATEGY_CANVAS
          : settings.cachingStrategy;
      if (settings.cachingStrategy !== Canvas2D.CACHESTRATEGY_CANVAS) {
        throw new Error(
          'Right now only the CACHESTRATEGY_CANVAS cache Strategy is supported for WorldSpace Canvas. More will come soon!'
        );
      }
      _this = _super.call(this, scene, settings) || this;
      BABYLON.Prim2DBase._isCanvasInit = false;
      _this._unitScaleFactor =
        settings.unitScaleFactor != null ? settings.unitScaleFactor : 1;
      ...
      _this._trackNodeOffset =
        settings.trackNodeOffset != null
          ? settings.trackNodeOffset
          : BABYLON.Vector3.Zero();
      _this._trackNodeBillboard =
        settings.trackNodeBillboard != null
          ? settings.trackNodeBillboard
          : true;
      var createWorldSpaceNode =
        !settings || settings.customWorldSpaceNode == null;
      ...
      if (settings.maxAdaptiveCanvasSize == null) {
        ...
        _this._maxAdaptiveWorldSpaceCanvasSize = Math.min(
          settings.maxAdaptiveCanvasSize,
          capMaxTextSize
        );
      }
      if (createWorldSpaceNode) {
        ...
        var vertexData = BABYLON.VertexData.CreatePlane({
          ...
          height: size.height,
          sideOrientation:
            (settings && settings.sideOrientation) || BABYLON.Mesh.DEFAULTSIDE,
        });
        ...
        if (settings && settings.sideOrientation) {
          mtl.backFaceCulling =
            settings.sideOrientation === BABYLON.Mesh.DEFAULTSIDE ||
            settings.sideOrientation === BABYLON.Mesh.FRONTSIDE;
        }
        plane.position =
          (settings && settings.worldPosition) || BABYLON.Vector3.Zero();
        plane.rotationQuaternion =
          (settings && settings.worldRotation) || BABYLON.Quaternion.Identity();
        plane.material = mtl;
...
(function(BABYLON) {
  var Command = (function() {
    function Command(execute, canExecute) {
      if (!execute) {
        throw Error(
          'At least an execute lambda must be given at Command creation time'
        );
      }
  ...
  var UIElement = (function(_super) {
    ...
    function UIElement(settings) {
      ...
      if (!settings) {
        throw Error(
          'A settings object must be passed with at least either a parent or owner parameter'
        );
      }
      ...
      _this._hierarchyDepth = 0;
      _this._renderingTemplateName =
        settings.templateName != null
          ? settings.templateName
          : GUIManager.DefaultTemplateName;
      _this._style =
        settings.styleName != null
          ? GUIManager.getStyle(type, settings.styleName)
          : null;
      _this._flags = 0;
      ...
      _this._maxWidth =
        settings.maxWidth != null ? settings.maxWidth : Number.MAX_VALUE;
      _this._maxHeight =
        settings.maxHeight != null ? settings.maxHeight : Number.MAX_VALUE;
      _this._margin = null;
      _this._padding = null;
      _this._marginAlignment = null;
    ...
    Object.defineProperty(UIElement.prototype, '_hasPaddingAlignment', {
      ...
      get: function() {
        return (
          this._paddingAlignment !== null && !this._paddingAlignment.isDefault
        );
      },
      enumerable: true,
      configurable: true,
    ...
    UIElement.prototype._assignTemplate = function(templateName) {
      ...
      if (!className) {
        throw Error(
          "Couldn't access class name of this UIElement, you have to decorate the type with the className decorator"
        );
      }
      var factory = GUIManager.getRenderingTemplate(className, templateName);
      if (!factory) {
        throw Error(
          "Couldn't get the renderingTemplate " +
            templateName +
            ' of class ' +
            className
        );
    ...
    UIElement.prototype._createVisualTree = function() {
      ...
      this._visualPlaceholder = new BABYLON.Group2D({
        ...
        id:
          'GUI ' +
          BABYLON.Tools.getClassName(this) +
          ' RootGroup of ' +
          this.id,
      });
      ...
      p.dataSource = this;
      p.createSimpleDataBinding(
        BABYLON.Prim2DBase.widthProperty,
        'width',
        BABYLON.DataBinding.MODE_ONEWAY
      );
      p.createSimpleDataBinding(
        BABYLON.Prim2DBase.heightProperty,
        'height',
        BABYLON.DataBinding.MODE_ONEWAY
      );
      p.createSimpleDataBinding(
        BABYLON.Prim2DBase.actualWidthProperty,
        'actualWidth',
        BABYLON.DataBinding.MODE_ONEWAYTOSOURCE
      );
      p.createSimpleDataBinding(
        BABYLON.Prim2DBase.actualHeightProperty,
        'actualHeight',
        BABYLON.DataBinding.MODE_ONEWAYTOSOURCE
      );
      p.createSimpleDataBinding(
        BABYLON.Prim2DBase.marginProperty,
        'margin',
        BABYLON.DataBinding.MODE_ONEWAY
      );
      p.createSimpleDataBinding(
        BABYLON.Prim2DBase.marginAlignmentProperty,
        'marginAlignment',
        BABYLON.DataBinding.MODE_ONEWAY
      );
    ...
    UIElement.prototype.createVisualTree = function() {
      var res = this._renderingTemplate.createVisualTree(
        this,
  ...
  var GUIManager = (function() {
    ...
    GUIManager.getStyle = function(uiElType, styleName) {
      ...
      if (!styles) {
        throw Error(
          'The type ' +
            uiElType +
            ' is unknown, no style were registered for it.'
        );
      }
    ...
    GUIManager.registerStyle = function(uiElType, templateName, style) {
      var templates = GUIManager.stylesByUIElement.getOrAddWithFactory(
        uiElType,
        function() {
          return new BABYLON.StringDictionary();
        }
    ...
    GUIManager.getRenderingTemplate = function(uiElType, templateName) {
      ...
      if (!templates) {
        throw Error(
          'The type ' +
            uiElType +
            ' is unknown, no Rendering Template were registered for it.'
        );
      }
    ...
    GUIManager.registerRenderingTemplate = function(
      uiElType,
      templateName,
      factory
    ) {
      var templates = GUIManager.renderingTemplatesByUIElement.getOrAddWithFactory(
        uiElType,
        function() {
          return new BABYLON.StringDictionary();
        }
...
(function(BABYLON) {
  var StackPanel = (StackPanel_1 = (function(_super) {
    ...
    function StackPanel(settings) {
      ...
      _this = _super.call(this, settings) || this;
      _this.isOrientationHorizontal =
        settings.isOrientationHorizontal == null
          ? true
          : settings.isOrientationHorizontal;
      _this._children = new Array();
      if (settings.children != null) {
        for (var _i = 0, _a = settings.children; _i < _a.length; _i++) {
          var child = _a[_i];
    ...
    StackPanel.prototype.createVisualTree = function() {
      ...
      p.layoutEngine = this.isOrientationHorizontal
        ? BABYLON.StackPanelLayoutEngine.Horizontal
        : BABYLON.StackPanelLayoutEngine.Vertical;
  ...
  __decorate(
    [
      BABYLON.dependencyProperty(
        StackPanel_1.STACKPANEL_PROPCOUNT + 0,
        function(pi) {
          return (StackPanel_1.orientationHorizontalProperty = pi);
        }
      ),
    ],
  ...
  var DefaultStackPanelRenderingTemplate = (DefaultStackPanelRenderingTemplate_1 = (function(
    _super
  ) {
    ...
    DefaultStackPanelRenderingTemplate.prototype.createVisualTree = function(
      owner,
      visualPlaceholder
    ) {
  ...
  DefaultStackPanelRenderingTemplate = DefaultStackPanelRenderingTemplate_1 = __decorate(
    [
      BABYLON.registerWindowRenderingTemplate(
        'BABYLON.StackPanel',
        'Default',
        function() {
          return new DefaultStackPanelRenderingTemplate_1();
        }
      ),
    ],
...
(function(BABYLON) {
  ...
  __decorate(
    [
      BABYLON.dependencyProperty(
        BABYLON.UIElement.UIELEMENT_PROPCOUNT + 0,
        function(pi) {
          return (Control_1.backgroundProperty = pi);
        }
      ),
    ],
    Control.prototype,
  ...
  __decorate(
    [
      BABYLON.dependencyProperty(
        BABYLON.UIElement.UIELEMENT_PROPCOUNT + 1,
        function(pi) {
          return (Control_1.borderProperty = pi);
        }
      ),
    ],
    Control.prototype,
  ...
  __decorate(
    [
      BABYLON.dependencyProperty(
        BABYLON.UIElement.UIELEMENT_PROPCOUNT + 2,
        function(pi) {
          return (Control_1.borderThicknessProperty = pi);
        }
      ),
    ],
    Control.prototype,
  ...
  __decorate(
    [
      BABYLON.dependencyProperty(
        BABYLON.UIElement.UIELEMENT_PROPCOUNT + 3,
        function(pi) {
          return (Control_1.fontNameProperty = pi);
        }
      ),
    ],
    Control.prototype,
  ...
  __decorate(
    [
      BABYLON.dependencyProperty(
        BABYLON.UIElement.UIELEMENT_PROPCOUNT + 4,
        function(pi) {
          return (Control_1.foregroundProperty = pi);
        }
      ),
    ],
    Control.prototype,
...
(function(BABYLON) {
  ...
  ContentControl.CONTENTCONTROL_PROPCOUNT =
    BABYLON.Control.CONTROL_PROPCOUNT + 2;
  __decorate(
    [
      BABYLON.dependencyProperty(
        BABYLON.Control.CONTROL_PROPCOUNT + 0,
        function(pi) {
          return (ContentControl_1.contentProperty = pi);
        }
      ),
    ],
...
(function(BABYLON) {
  ...
  var FocusManager = (function() {
    ...
    FocusManager.prototype.setFocusOn = function(el, focusScope) {
      var fsd =
        focusScope != null
          ? this._focusScopes.getOrAddWithFactory(focusScope.uid, function(k) {
  ...
  var Window = (Window_1 = (function(_super) {
    ...
    function Window(scene, settings) {
      ...
      if (!settings.worldPosition && !settings.worldRotation) {
        ...
        var wpos =
          settings.worldPosition == null
            ? BABYLON.Vector3.Zero()
            : settings.worldPosition;
        var wrot =
          settings.worldRotation == null
            ? BABYLON.Quaternion.Identity()
            : settings.worldRotation;
        _this._canvas = new BABYLON.WorldSpaceCanvas2D(
          scene,
          new BABYLON.Size(w, h),
          {
            id: 'GUI Canvas',
            cachingStrategy: BABYLON.Canvas2D.CACHESTRATEGY_DONTCACHE,
            worldPosition: wpos,
      ...
      _this._renderObserver = _this._canvas.renderObservable.add(function(
        e,
        s
      ) {
        return _this._canvasPreRender();
      }, BABYLON.Canvas2D.RENDEROBSERVABLE_PRE);
      _this._disposeObserver = _this._canvas.disposeObservable.add(function(
        e,
        s
      ) {
    ...
    Window.prototype._overPrimChanged = function(oldPrim, newPrim) {
      ...
      var newOverEl = null;
      var curGroup = newPrim
        ? newPrim.traverseUp(function(p) {
      ...
      while (curGroup) {
        ...
        curGroup = curGroup.parent
          ? curGroup.parent.traverseUp(function(p) {
              return p instanceof BABYLON.Group2D;
            })
          : null;
      }
    ...
    Window.prototype._canvasPreRender = function() {
      ...
      if (this._UIElementVisualToBuildList.length > 0) {
        ...
        var sortedElementList = this._UIElementVisualToBuildList.sort(function(
          a,
          b
        ) {
          return a.hierarchyDepth - b.hierarchyDepth;
        ...
        for (
          var _i = 0, sortedElementList_1 = sortedElementList;
          _i < sortedElementList_1.length;
          _i++
        ) {
    ...
    Window.getSceneData = function(scene) {
      return Window_1._sceneData.getOrAddWithFactory(scene.uid, function(k) {
  ...
  __decorate(
    [
      BABYLON.dependencyProperty(
        BABYLON.ContentControl.CONTENTCONTROL_PROPCOUNT + 0,
        function(pi) {
          return (Window_1.leftProperty = pi);
        }
      ),
    ],
    Window.prototype,
  ...
  __decorate(
    [
      BABYLON.dependencyProperty(
        BABYLON.ContentControl.CONTENTCONTROL_PROPCOUNT + 1,
        function(pi) {
          return (Window_1.bottomProperty = pi);
        }
      ),
    ],
    Window.prototype,
  ...
  __decorate(
    [
      BABYLON.dependencyProperty(
        BABYLON.ContentControl.CONTENTCONTROL_PROPCOUNT + 2,
        function(pi) {
          return (Window_1.positionProperty = pi);
        }
      ),
    ],
    Window.prototype,
  ...
  __decorate(
    [
      BABYLON.dependencyProperty(
        BABYLON.ContentControl.CONTENTCONTROL_PROPCOUNT + 3,
        function(pi) {
          return (Window_1.isActiveProperty = pi);
        }
      ),
    ],
    Window.prototype,
  ...
  var DefaultWindowRenderingTemplate = (DefaultWindowRenderingTemplate_1 = (function(
    _super
  ) {
    ...
    DefaultWindowRenderingTemplate.prototype.createVisualTree = function(
      owner,
      visualPlaceholder
    ) {
  ...
  DefaultWindowRenderingTemplate = DefaultWindowRenderingTemplate_1 = __decorate(
    [
      BABYLON.registerWindowRenderingTemplate(
        ...
        'Default',
        function() {
          return new DefaultWindowRenderingTemplate_1();
        }
      ),
    ],
...
(function(BABYLON) {
  ...
  __decorate(
    [
      BABYLON.dependencyProperty(
        BABYLON.Control.CONTROL_PROPCOUNT + 0,
        function(pi) {
          return (Label_1.textProperty = pi);
        }
      ),
    ],
    Label.prototype,
  ...
  Label = Label_1 = __decorate([BABYLON.className('Label', 'BABYLON')], Label);
  BABYLON.Label = Label;
  var DefaultLabelRenderingTemplate = (DefaultLabelRenderingTemplate_1 = (function(
    _super
  ) {
    ...
    DefaultLabelRenderingTemplate.prototype.createVisualTree = function(
      owner,
      visualPlaceholder
    ) {
  ...
  DefaultLabelRenderingTemplate = DefaultLabelRenderingTemplate_1 = __decorate(
    [
      BABYLON.registerWindowRenderingTemplate(
        ...
        'Default',
        function() {
          return new DefaultLabelRenderingTemplate_1();
        }
      ),
    ],
...
(function(BABYLON) {
  var Button = (Button_1 = (function(_super) {
    ...
    function Button(settings) {
      ...
      if (settings.paddingAlignment == null) {
        _this.paddingAlignment.horizontal =
          BABYLON.PrimitiveAlignment.AlignCenter;
        _this.paddingAlignment.vertical =
          BABYLON.PrimitiveAlignment.AlignCenter;
      }
      _this._normalStateBackground = new BABYLON.ObservableStringDictionary(
        false
      );
      _this._normalStateBorder = new BABYLON.ObservableStringDictionary(false);
      _this._defaultStateBackground = new BABYLON.ObservableStringDictionary(
        false
      );
      _this._defaultStateBorder = new BABYLON.ObservableStringDictionary(false);
      _this._normalStateBackground.add(
        BABYLON.UIElement.enabledState,
        BABYLON.Canvas2D.GetSolidColorBrushFromHex('#337AB7FF')
      );
      _this._normalStateBackground.add(
        BABYLON.UIElement.disabledState,
        BABYLON.Canvas2D.GetSolidColorBrushFromHex('#7BA9D0FF')
      );
      _this._normalStateBackground.add(
        BABYLON.UIElement.mouseOverState,
        BABYLON.Canvas2D.GetSolidColorBrushFromHex('#286090FF')
      );
      _this._normalStateBackground.add(
        Button_1.pushedState,
        BABYLON.Canvas2D.GetSolidColorBrushFromHex('#1E496EFF')
      );
      _this._normalStateBorder.add(
        BABYLON.UIElement.enabledState,
        BABYLON.Canvas2D.GetSolidColorBrushFromHex('#2E6DA4FF')
      );
      _this._normalStateBorder.add(
        BABYLON.UIElement.disabledState,
        BABYLON.Canvas2D.GetSolidColorBrushFromHex('#77A0C4FF')
      );
      _this._normalStateBorder.add(
        BABYLON.UIElement.mouseOverState,
        BABYLON.Canvas2D.GetSolidColorBrushFromHex('#204D74FF')
      );
      _this._normalStateBorder.add(
        Button_1.pushedState,
        BABYLON.Canvas2D.GetSolidColorBrushFromHex('#2E5D9EFF')
      );
      _this._defaultStateBackground.add(
        BABYLON.UIElement.enabledState,
        BABYLON.Canvas2D.GetSolidColorBrushFromHex('#FFFFFFFF')
      );
      _this._defaultStateBackground.add(
        BABYLON.UIElement.disabledState,
        BABYLON.Canvas2D.GetSolidColorBrushFromHex('#FFFFFFFF')
      ...
      _this._defaultStateBackground.add(
        BABYLON.UIElement.mouseOverState,
        BABYLON.Canvas2D.GetSolidColorBrushFromHex('#E6E6E6FF')
      );
      _this._defaultStateBackground.add(
        Button_1.pushedState,
        BABYLON.Canvas2D.GetSolidColorBrushFromHex('#D4D4D4FF')
      );
      _this._defaultStateBorder.add(
        BABYLON.UIElement.enabledState,
        BABYLON.Canvas2D.GetSolidColorBrushFromHex('#CCCCCCFF')
      );
      _this._defaultStateBorder.add(
        BABYLON.UIElement.disabledState,
        BABYLON.Canvas2D.GetSolidColorBrushFromHex('#DEDEDEFF')
      );
      _this._defaultStateBorder.add(
        BABYLON.UIElement.mouseOverState,
        BABYLON.Canvas2D.GetSolidColorBrushFromHex('#ADADADFF')
      );
      _this._defaultStateBorder.add(
        Button_1.pushedState,
        BABYLON.Canvas2D.GetSolidColorBrushFromHex('#6C8EC5FF')
      );
      return _this;
    }
  ...
  __decorate(
    [
      BABYLON.dependencyProperty(
        BABYLON.ContentControl.CONTROL_PROPCOUNT + 0,
        function(pi) {
          return (Button_1.isPushedProperty = pi);
        }
      ),
    ],
    Button.prototype,
  ...
  __decorate(
    [
      BABYLON.dependencyProperty(
        BABYLON.ContentControl.CONTROL_PROPCOUNT + 1,
        function(pi) {
          return (Button_1.isDefaultProperty = pi);
        }
      ),
    ],
    Button.prototype,
  ...
  __decorate(
    [
      BABYLON.dependencyProperty(
        BABYLON.ContentControl.CONTROL_PROPCOUNT + 2,
        function(pi) {
          return (Button_1.isOutlineProperty = pi);
        }
      ),
    ],
    Button.prototype,
  ...
  var DefaultButtonRenderingTemplate = (DefaultButtonRenderingTemplate_1 = (function(
    _super
  ) {
    ...
    DefaultButtonRenderingTemplate.prototype.createVisualTree = function(
      owner,
      visualPlaceholder
    ) {
    ...
    DefaultButtonRenderingTemplate.prototype.stateChange = function() {
      ...
      var bg = b.isDefault
        ? b.defaultStateBackground.get(state)
        : b.normalStateBackground.get(state);
      var bd = b.isDefault
        ? b.defaultStateBorder.get(state)
        : b.normalStateBorder.get(state);
      if (b.isPushed) {
  ...
  DefaultButtonRenderingTemplate = DefaultButtonRenderingTemplate_1 = __decorate(
    [
      BABYLON.registerWindowRenderingTemplate(
        ...
        'Default',
        function() {
          return new DefaultButtonRenderingTemplate_1();
        }
      ),
    ],
